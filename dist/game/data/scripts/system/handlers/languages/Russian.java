...
/**
 * This class provides the localization data for the {@code Russian} language.<br>
 * It handles the mapping of {@link CustomMessageId} to Russian text strings.
 */
public class Russian extends Language
{
	/**
	 * Initializes the Russian language handler.<br>
	 * This constructor registers the {@code ru} locale and adds supported language codes.<br>
	 * It also populates the system with translated messages for various game commands and events.
	 */
	public Russian()
	{
		super("ru");
