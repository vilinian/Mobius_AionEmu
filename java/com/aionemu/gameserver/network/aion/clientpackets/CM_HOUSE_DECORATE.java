...
/**
 * Handles the client request to place or modify a decoration within a house.<br>
 * This packet processes data sent by the player to update {@link HouseDecoration} objects.<br>
 * It interacts with the {@link House} model and validates actions against current game states.
 * @author Rolandas
 */
public class CM_HOUSE_DECORATE extends AionClientPacket
{
	...
	/**
	 * This packet handles house decoration actions.<br>
