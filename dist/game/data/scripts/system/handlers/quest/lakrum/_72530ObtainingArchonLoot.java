...
/**
 * Handles the logic for obtaining Archon loot during quest {@code 72530}.<br>
 * This class manages the specific requirements and rewards associated with this objective.
...
public class _72530ObtainingArchonLoot extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for obtaining Archon loot.<br>
	 * This constructor sets the {@code questId} to {@code 72530}.<br>
	 * It calls the superclass constructor to register this quest.
	 */
