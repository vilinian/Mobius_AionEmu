...
/**
 * Handles the quest logic for {@code 60504StoppingBalaurSupplies}.<br>
...
public class _60504StoppingBalaurSupplies extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the {@code 60504StoppingBalaurSupplies} quest.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 3, Count: 3, Mobs : 655444 // (1) Step: 3, Count: 1, Mobs : 655445 // (2) Step: 5, Count: 3, Mobs : 655446 // (3) Step: 5, Count: 1, Mobs : 703553 switch (var) { case 3: { // ??? } case 3: { return defaultOnKillEvent(env, 655445, 3, 4, 0); } case 5: { // ??? } case 5: { qs.setQuestVar(6); qs.setStatus(QuestStatus.REWARD); updateQuestStatus(env); return true; } default: break; } return false; } return false; }
	 */
}
