...
/**
 * This effect ensures that the target always performs a parry action.<br>
 * It is used to modify attack behavior by forcing a {@code true} result for parry checks.
 * @author ATracer
 */
