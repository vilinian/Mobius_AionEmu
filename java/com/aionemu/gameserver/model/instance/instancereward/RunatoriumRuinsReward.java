...
/**
 * This class defines the rewards granted for completing the {@link RunatoriumRuinsPlayerReward} instance.<br>
 * It handles the logic for distributing specific items or effects to players upon completion.
 * @author GiGatR00n
 */
public class RunatoriumRuinsReward extends InstanceReward<RunatoriumRuinsPlayerReward>
{
	...
	/**
	 * Creates a new {@code RunatoriumRuinsReward} object.<br>
	 ...
	 * If not, it adds a new {@code RunatoriumRuinsPlayerReward} to the list.
	 ...
	 * This method calls the superclass implementation to register the {@code RunatoriumRuinsPlayerReward}.
	 * @param reward The {@code RunatoriumRuinsPlayerReward} object to be added.
	 */
	@Override
	 ...
	 * This method casts the result to a {@link RunatoriumRuinsPlayerReward}.
	 * @param object The unique identifier of the object or player.
	 * @return The {@code RunatoriumRuinsPlayerReward} associated with the provided object.
	 */
	@Override
	 ...
	 * @return A {@code List} of {@link RunatoriumRuinsPlayerReward} objects sorted by points.
	 */
	public List<RunatoriumRuinsPlayerReward> sortPoints()
	{
		return getInstanceRewards().stream().sorted(Comparator.comparingInt(RunatoriumRuinsPlayerReward::getScorePoints).reversed()).collect(Collectors.toList());
	}
