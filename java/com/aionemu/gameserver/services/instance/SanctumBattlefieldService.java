...
/**
 * Manages the logic and mechanics for the Sanctum Battlefield instance.<br>
...
public class SanctumBattlefieldService
{
	...
	/**
	 * Retrieves the global instance of the {@link SanctumBattlefieldService}.<br>
	 * This method follows the singleton pattern.<br>
	 * Use this to access the service from anywhere in the code.
	 * @return The single instance of {@code SanctumBattlefieldService}.
	 */
	...
	/**
	 * Starts the Sanctum Battlefield service.<br>
	 ...
	 * Logs the scheduled duration and expression to the server log.
	 */
	public void start()
	{
		final String[] times = AutoGroupConfig.SANCTUMBATTLEFIELD_TIMES.split("\\|");
	...
	/**
	 * Checks if the Sanctum Battlefield is currently open for registration.<br>
