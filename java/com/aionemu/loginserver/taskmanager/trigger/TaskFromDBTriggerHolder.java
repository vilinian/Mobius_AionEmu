...
/**
 * This class acts as a holder for triggers that are loaded from the database.<br>
 * It allows the system to manage and access various {@link com.aionemu.loginserver.taskmanager.trigger.TaskFromDBTrigger} types.<br>
 * Use this enum to handle tasks triggered by specific events or schedules stored in the DB.
 * @author nrg
 */
