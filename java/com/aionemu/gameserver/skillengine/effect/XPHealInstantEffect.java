...
/**
 * This class handles the immediate restoration of experience points to a {@link Player}.<br>
 * It triggers an instant update and sends the corresponding {@code SM_STATUPDATE_EXP} packet.<br>
 * Use this effect when a skill or event should grant XP immediately without any delay.
