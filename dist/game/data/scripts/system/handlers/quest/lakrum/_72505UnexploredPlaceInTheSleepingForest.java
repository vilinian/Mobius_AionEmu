...
/**
 * Handles the quest logic for "Unexplored Place in the Sleeping Forest".<br>
...
public class _72505UnexploredPlaceInTheSleepingForest extends QuestHandler
{
	...
	/**
	 * Initializes a new instance of the {@code _72505UnexploredPlaceInTheSleepingForest} quest handler.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 1, Count: 1, Mobs : 655315 if (var == 1 && var1 < 0) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(2); updateQuestStatus(env); } } return false; }
	 */
}
