...
/**
 * Defines the different categories of effects that can be applied to entities.<br>
 * This enum is used by the {@code Effect} system to determine how an effect behaves.<br>
 * It helps distinguish between types such as buffs, debuffs, and environmental changes.
 * @author kecimis
 */
