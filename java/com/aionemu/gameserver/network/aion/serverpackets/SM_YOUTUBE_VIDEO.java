...
/**
 * This packet handles the communication for YouTube video content.<br>
 * It is used to send video information from the server to the client.
 * @author FrozenKiller
 */
