...
/**
 * Handles the progress logic for quest {@code 80504} during the "Prosperity of the Elyos" event.<br>
 * This class manages specific state transitions and actions triggered by players within this quest sequence.
...
public class _80504ProgressProsperityOfTheElyos18 extends QuestHandler
{
	 ...
	 * This constructor sets the {@code questId} to {@code 80504}.<br>
	 * It calls the superclass constructor to register the ID.
	 */
