...
/**
 * Handles the logic for moving a target creature behind the attacker.<br>
 * This effect is typically used by skills to reposition enemies during an attack.
...
public class MoveBehindEffect extends EffectTemplate
{
	...
	public void calculate(Effect effect)
	{
		...
		final Vector3f closestCollision = GeoService.getInstance().getClosestCollision(effector, effected.getX() + x1, effected.getY() + y1, effected.getZ(), false, intentions);
