...
/**
 * Represents the rewards granted to players for participating in the {@code SanctumBattlefield}.<br>
 * This class extends {@link InstancePlayerReward} to handle specific loot and benefits for this instance.
 * @author Falke_34
 */
public class SanctumBattlefieldPlayerReward extends InstancePlayerReward
{
	...
	/**
	 * Creates a new {@link SanctumBattlefieldPlayerReward} instance.<br>
	 * This constructor initializes the reward with a default status of {@code false}.
	 * @param object The underlying data object passed to the superclass.
	 */
