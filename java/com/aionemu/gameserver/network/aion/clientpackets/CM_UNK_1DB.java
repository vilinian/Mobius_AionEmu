...
/**
 * This class handles the {@code CM_UNK_1DB} client packet.<br>
 * It processes unknown data received from the client during the game session.
 * @author Falke_34
 */
public class CM_UNK_1DB extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of {@link CM_UNK_1DB}.<br>
