...
/**
 * Handles the {@code CM_LUNA_SYSTEM} client packet sent to the server.<br>
 * This class processes requests related to the Luna system and interacts with {@link LunaShopService}.<br>
 * It may trigger various responses such as {@link SM_MESSAGE} or {@link SM_SYSTEM_MESSAGE}.
 */
public class CM_LUNA_SYSTEM extends AionClientPacket
{
	...
	/**
	 * This constructor initializes a new {@code CM_LUNA_SYSTEM} packet.<br>
