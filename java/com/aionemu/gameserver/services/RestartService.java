...
/**
 * This service handles the logic for restarting the game server.<br>
 * It manages necessary data persistence and cleanup tasks before a shutdown.<br>
 * Use this class to ensure all player data is saved correctly during maintenance.
 * @author nrg
 * @rework Blackfire
 */
public class RestartService
{
	...
	/**
	 * Initializes the scheduled tasks for server restarts.<br>
	 * This method configures cron jobs to reset achievements and shops.<br>
	 * It also schedules periodic service restarts using {@link CronService}.
	 */
	public void onStart()
	{
		...
		final String daily1 = "0 0 9 ? * * *";
		final String daily2 = "0 0 0/12 ? * * *";
	...
	/**
	 * Provides the global instance of the {@link RestartService}.<br>
	 * This method follows the singleton pattern.
	 * @return The single instance of {@code RestartService}.
	 */
