...
/**
 * This packet handles the result of a tuning action performed by the client.<br>
 * It processes information sent from the {@link Player} to update the game state accordingly.
 * @author Falke_34
 */
public class CM_TUNE_RESULT extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of {@link CM_TUNE_RESULT}.<br>
	 * This constructor initializes the packet with specific states.
	 * @param opcode The unique identifier for this packet type.
	 * @param state The primary {@link State} associated with the result.
