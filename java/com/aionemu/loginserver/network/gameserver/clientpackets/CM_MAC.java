...
/**
 * This class handles the {@code CM_MAC} packet sent from the game server to the client.<br>
 * It is used to transmit the Media Access Control (MAC) address information.
 * @author nrg
 */
