...
/**
 * This packet notifies the client which map it should load.<br>
 * It is used to handle player spawning and initial world placement.
 * @author -Nemesiss-
 */
public class SM_PLAYER_SPAWN extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_PLAYER_SPAWN} packet.<br>
	 * This packet notifies the client about the map to load.<br>
	 * It initializes the packet with the specified {@link Player}.
	 * @param player The {@code Player} object that is entering the game.
	 */
