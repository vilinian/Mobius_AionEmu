...
/**
 * Handles the progress logic for gathering {@code Colourful Arachna Fluid}.<br>
 * This class updates the quest state when a player collects the required items.
...
public class _80438ProgressGatherColourfulArachnaFluid extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for gathering Colorful Arachna Fluid.<br>
	 * This method sets up the internal state for quest {@code 80438}.<br>
