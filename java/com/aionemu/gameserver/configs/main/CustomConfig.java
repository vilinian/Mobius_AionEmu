...
/**
 * This class manages custom configuration settings for the game server.<br>
 * It allows developers to define and access specific properties that are not covered by standard configurations.
 */
