...
/**
 * This packet handles the request to find a group in the game world.<br>
 * It processes data sent by the client to search for available groups.<br>
 * It utilizes {@link FindGroup} to manage the underlying logic.
 * @author cura, MrPoke
 */
public class SM_FIND_GROUP extends AionServerPacket
{
	...
	/**
	 * This method creates a new {@code SM_FIND_GROUP} packet.<br>
	 * It initializes the group search data for the client.
	 * @param action The specific action type to perform.
	 * @param lastUpdate The timestamp of the most recent update.
	 * @param findGroups A collection of {@link FindGroup} objects to include in the packet.
	 */
	...
	/**
	 * This method initializes a new {@code SM_FIND_GROUP} packet.<br>
	 * It sets the basic action and update values for the group search.
	 * @param action The specific action type to perform.
	 * @param lastUpdate The timestamp of the most recent update.
	 * @param unk An unknown value used for internal processing.
	 */
	...
	/**
	 * Creates a new {@code SM_FIND_GROUP} packet.<br>
	 * This method initializes the packet with specific group search data.
