...
/**
 * This class handles the localization of game text into Portuguese.<br>
 * It extends {@link Language} to provide specific translations for the Brazilian and European variants.
 * @author Eloann
 * @reworked Voidstar
...
{
	/**
	 * Initializes the Portuguese language configuration.<br>
	 * This constructor registers the {@code pt} and {@code pt_PT} locales.<br>
	 * It also loads all translated messages for the Portuguese language.
	 */
	public Portuguese()
	{
		super("pt");
