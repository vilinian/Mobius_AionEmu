...
/**
 * Handles the client request to equip an {@link Item} onto a player.<br>
 * This packet processes the logic for moving an item into an {@link Equipment} slot.
...
public class CM_EQUIP_ITEM extends AionClientPacket
{
	...
	/**
	 * Creates a new {@link CM_EQUIP_ITEM} packet.<br>
