...
/**
 * Handles the logic for a player mounting or riding a creature.<br>
 * This action processes {@link Item} usage to initiate a ride state with a {@link Creature}.<br>
 * It manages necessary animations, system messages, and movement permissions.
...
public class RideAction extends AbstractItemAction
{
	 ...
	 * It checks for null items and ride restrictions based on the current zone.
	...
	/**
	 * Executes the action for mounting a ride.<br>
	 * This method handles the logic when a {@link Player} uses an item to enter a riding state.
	...
	/**
	 * Retrieves the ride information for this action.<br>
	 * It fetches data from {@link DataManager}.
	 * @return the {@code RideInfo} object associated with this NPC.
	 */
