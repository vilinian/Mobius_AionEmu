...
/**
 * Handles the {@code CM_CHECK_MAIL_SIZE2} client packet.<br>
 * This packet is used to verify the size of a player's mail inbox.<br>
 * It allows the client to determine if it can display the full list of messages.
 */
public class CM_CHECK_MAIL_SIZE2 extends AionClientPacket
{
	/**
	 * This method initializes a new {@code CM_CHECK_MAIL_SIZE2} packet.<br>
