...
/**
 * Handles the client request to teleport a player to a specific hotspot.<br>
 * This packet triggers the {@link HotspotTeleportService} to process the movement.<br>
 * It validates the request and sends back an {@link SM_HOTSPOT_TELEPORT} or {@link SM_SYSTEM_MESSAGE}.
 * @author Alcapwnd
 */
public class CM_HOTSPOT_TELEPORT extends AionClientPacket
{
	...
	/**
	 * This method creates a new {@code CM_HOTSPOT_TELEPORT} packet.<br>
