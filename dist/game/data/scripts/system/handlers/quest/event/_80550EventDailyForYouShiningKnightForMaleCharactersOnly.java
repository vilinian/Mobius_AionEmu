...
/**
 * Handles the daily quest event "For You Shining Knight" specifically for male characters.<br>
 * This class manages the logic required to trigger and progress this unique quest instance.
...
public class _80550EventDailyForYouShiningKnightForMaleCharactersOnly extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the Shining Knight daily event.<br>
	 * This quest is specifically restricted to male characters only.<br>
	 * It sets the internal {@code questId} to {@code 80550}.
	 */
