...
/**
 * Represents the tail section of a mail template.<br>
 * This class is used to define the closing content for messages sent to players.
 * @author Rolandas
 */
...
public class Tail extends MailPart
{
	 ...
	 * If no specific type is set, it returns {@code TAIL}.
