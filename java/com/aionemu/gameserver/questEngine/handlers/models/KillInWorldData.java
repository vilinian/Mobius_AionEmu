...
/**
 * This class holds the data required for a quest objective that involves killing specific monsters in the world.<br>
 * It stores configuration details used by the {@link KillInWorld} handler to track player progress.
...
public class KillInWorldData extends XMLQuest
{
	 ...
	 * It creates a new {@link KillInWorld} instance.<br>
	...
	public void register(QuestEngine questEngine)
	{
		...
		final KillInWorld template = new KillInWorld(id, endNpcIds, startNpcIds, worldIds, amount, invasionWorld, endDialog);
