...
/**
 * Handles the logic for the weekly quest "Defend The 126th Garrison".<br>
...
public class _72561WeeklyDefendThe126thGarrison extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the weekly defense of the 126th Garrison.<br>
	 * This method sets up the quest with the ID {@code 72561}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 5, Mobs : 886270, 886271, 886272, 886273 if (var == 0 && var1 < 4) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(1); updateQuestStatus(env); } } return false; }
	 */
}
