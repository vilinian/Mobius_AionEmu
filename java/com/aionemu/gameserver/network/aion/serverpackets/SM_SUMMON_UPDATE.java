...
/**
 * This packet updates the status of a {@link Summon} for the client.<br>
 * It synchronizes changes to the summon's state and its associated {@link SummonGameStats}.
 * @author ATracer
 */
public class SM_SUMMON_UPDATE extends AionServerPacket
{
	...
	/**
	 * Updates the status of a specific summon.<br>
	 * This packet sends information about a {@link Summon} to the client.
	 * @param summon The {@code Summon} object to be updated.
	 */
	...
	{
		final SummonGameStats stats = summon.getGameStats();
