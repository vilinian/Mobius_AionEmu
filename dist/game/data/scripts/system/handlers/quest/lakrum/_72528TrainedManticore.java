...
/**
 * Handles the quest logic for the {@code 72528TrainedManticore} objective.<br>
 * This class manages specific interactions and requirements related to this quest step.
...
public class _72528TrainedManticore extends QuestHandler
{
	...
	/**
	 * Initializes a new instance of the {@link _72528TrainedManticore} quest handler.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 5, Mobs : 655320 if (var == 0 && var1 < 4) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(1); updateQuestStatus(env); } } return false; }
	 */
}
