...
/**
 * This packet handles the request from the {@code aion} client to create a new character.<br>
 * It processes the data sent by the user to initialize a new player profile in the game world.
 * @author -Nemesiss-
 * @modified cura
 * @rework FrozenKiller
 */
public class CM_CREATE_CHARACTER extends AionClientPacket
{
	...
	/**
	 * This method initializes a new {@link CM_CREATE_CHARACTER} packet.<br>
	 * It sets the required network states for character creation.
