...
/**
 * This class handles the {@code CM_CUBIC} client packet.<br>
 * It is used to process cubic-related actions for a {@link Player}.<br>
 * It interacts with the {@link PlayerCubicService} to manage these requests.
 * @author Falke_34
 * @rework Phantom_KNA
 */
public class CM_CUBIC extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of {@link CM_CUBIC}.<br>
