...
/**
 * Manages the specific logic and events for the {@code RunatoriumRuins} instance.<br>
 * This service handles instance-specific behaviors such as automated tasks or unique environmental effects.
 * @author GiGatR00n
 */
public class RunatoriumRuinsService
{
	 ...
	 * Use this method to access the global {@link RunatoriumRuinsService} object.
	 * @return The active {@code RunatoriumRuinsService} instance.
	 */
	...
	/**
	 * Starts the Runatorium Ruins instance service.<br>
	 * This method parses the cron expressions from {@link AutoGroupConfig}.<br>
	 * It schedules the registration process using the {@link CronService}.<br>
	 * Each scheduled task will trigger the {@code startRegistration} method.
	 */
	public void start()
	{
		final String[] times = AutoGroupConfig.RUNATORIUMRUINS_TIMES.split("\\|");
	...
	/**
	 * Initializes the registration process for the Runatorium Ruins instance.<br>
	...
	/**
	 * Schedules the unregistration process for the Runatorium Ruins instance.<br>
	...
	/**
	 * Checks if the Runatorium Ruins instance is currently open for registration.<br>
