...
/**
 * This packet handles the assembly of {@link AssembledNpc} objects.<br>
 * It is used to synchronize assembled NPC data between the server and the client.
 * @author xTz
 */
public class SM_NPC_ASSEMBLER extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_NPC_ASSEMBLER} packet.<br>
	 * This constructor initializes the packet using data from an {@link AssembledNpc}.<br>
	 * It sets the internal route ID and time on map values.
	 * @param assembledNpc The {@code AssembledNpc} object containing the assembly data.
	 */
