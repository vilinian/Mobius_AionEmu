...
/**
 * Handles the client request to interact with a private store.<br>
 * This packet allows players to purchase items from a merchant's inventory.<br>
 * It communicates with the {@link PrivateStoreService} to process transactions.
 * @author Simple
 */
public class CM_PRIVATE_STORE extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_PRIVATE_STORE} packet.<br>
