...
/**
 * Handles the request from a client to open an exchange window.<br>
 * It validates the player's ability to trade and interacts with the {@link ExchangeService}.
 * @author -Avol-
 */
public class CM_EXCHANGE_REQUEST extends AionClientPacket
{
	...
	/**
	 * Creates a new {@link CM_EXCHANGE_REQUEST} packet.<br>
