...
/**
 * This packet updates the client on the progress of a player's collection.<br>
 * It is used to synchronize the current state of {@link PlayerCollectionEntry} data.
 */
public class SM_PLAYER_COLLECTION_PROGRESS extends AionServerPacket
{
	...
	/**
	 * Creates a new progress packet for a specific player.<br>
	 * This packet updates the client on collection status.
	 * @param player The {@link Player} object associated with this progress update.
	 */
