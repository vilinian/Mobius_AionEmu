...
/**
 * This class represents the data structure for an item collection quest.<br>
 * It stores the specific requirements and items a player must gather to complete the task.
 * @author MrPoke
 * @modified Rolandas
 */
...
public class ItemCollectingData extends XMLQuest
{
	 ...
	 * It creates a new {@link ItemCollecting} instance.<br>
