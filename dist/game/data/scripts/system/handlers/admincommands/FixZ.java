...
/**
 * Handles the {@code FixZ} admin command to correct vertical coordinates.<br>
 * This utility allows administrators to reset a player's Z-axis position to prevent them from falling through the map.
 */
public class FixZ extends AdminCommand
{
	/**
	 * Initializes a new instance of the {@link FixZ} command.<br>
	 * This class handles the fixz admin command.
	 */
	public FixZ()
	{
		super("fixz");
	...
	/**
	 * Fixes the Z coordinate of a targeted {@link Npc}.<br>
	 * It deletes the current NPC and respawns it at its original location with the admin's height.
