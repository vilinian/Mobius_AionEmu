...
/**
 * Handles the distribution settings for loot and rewards within a group.<br>
 * This packet allows the server to communicate specific {@code LootGroupRules} to the client.
...
public class CM_DISTRIBUTION_SETTINGS extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of {@link CM_DISTRIBUTION_SETTINGS}.<br>
