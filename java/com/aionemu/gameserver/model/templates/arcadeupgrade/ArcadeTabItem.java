...
/**
 * Represents an individual item within an arcade upgrade tab.<br>
 * This class holds the data required to display and manage specific items in the {@link com.aionemu.gameserver.model.templates.arcadeupgrade.ArcadeTabItemList} structure.
 * @author Raziel
 */
