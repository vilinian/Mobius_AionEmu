...
/**
 * This class handles the calculation logic for the {@code maxHp} statistic.<br>
 * It determines how a character's maximum health is derived based on various stats.<br>
 * It extends the base {@link StatFunction} class.
 */
class MaxHpFunction extends StatFunction
{
	/**
	 * This function handles the calculation for {@code MAXHP}.<br>
	 * It sets the target stat to {@code MAXHP}.<br>
	 * Use this when you need to modify maximum health values.
	 */
	MaxHpFunction()
	{
		stat = StatEnum.MAXHP;
	 ...
	 * This method calculates a new value based on the owner's current health.<br>
	...
	{
		final float health = stat.getOwner().getGameStats().getHealth().getCurrent();
