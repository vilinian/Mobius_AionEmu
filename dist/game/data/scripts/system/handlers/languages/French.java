 ...
 */
package system.handlers.languages;

import com.aionemu.gameserver.utils.i18n.CustomMessageId;
import com.aionemu.gameserver.utils.i18n.Language;

/**
 * This class handles the localization settings for the {@code French} language.<br>
 * It provides the necessary translations and configurations for users who select French as their primary language.
 * @author Pearl
 * @reworked Voidstar
 */
...
{
	/**
	 * Initializes the French language handler.<br>
	 * This constructor sets up the {@code fr} locale and adds supported regional codes.<br>
	 * It also registers all translated messages for the French language.
	 */
	public French()
	{
		super("fr");
