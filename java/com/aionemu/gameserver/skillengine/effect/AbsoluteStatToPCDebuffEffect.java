...
/**
 * This class handles effects that apply a debuff to a player based on an absolute stat value.<br>
 * It extends {@link AbstractAbsoluteStatEffect} to provide specific logic for converting stats into {@code PCDebuff} values.
 * @author Rolandas
 */
