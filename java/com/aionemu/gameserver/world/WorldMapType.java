...
/**
 * Defines the different types of maps available in the game world.<br>
 * This enumeration is used to categorize map properties and behaviors for the {@link com.aionemu.gameserver.world.World} system.
 */
public enum WorldMapType
{
	...
	/**
	 * Creates a new {@code WorldMapType} instance using only the world identifier.<br>
	 * This method treats the map as a non-personal map by default.
	...
	/**
	 * Creates a new {@link WorldMapType} instance.<br>
	 * This constructor initializes the map with a specific ID and personal status.
	 * @param worldId The unique identifier for the world map.
	 * @param personal A boolean flag indicating if the map is private.
	 */
	...
	/**
	 * Retrieves the unique identifier for this {@link WorldMapType}.<br>
	 * This value corresponds to the internal type code.
	 * @return The integer ID of the map type.
	 */
	public int getId()
	{
		return worldId;
	...
	/**
	 * Retrieves a {@link WorldMapType} based on its unique identifier.<br>
	 * This method searches through all available types to find a match.
	 * @param id The unique integer ID of the world map.
	 * @return The matching {@link WorldMapType} or {@code null} if no match is found.
	 */
