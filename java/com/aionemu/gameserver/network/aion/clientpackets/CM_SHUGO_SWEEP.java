...
/**
 * Handles the client request to trigger a {@code ShugoSweep} action.<br>
 * This packet is processed by the server to initiate the sweep mechanic for the player.
 * @author Ghostfur
 */
public class CM_SHUGO_SWEEP extends AionClientPacket
{
	...
	/**
	 * This method initializes a new {@code CM_SHUGO_SWEEP} packet.<br>
