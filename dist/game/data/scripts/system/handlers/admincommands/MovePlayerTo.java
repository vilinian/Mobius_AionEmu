...
/**
 * Handles the admin command to teleport a specific player to a designated location.<br>
 * It validates the target coordinates and moves the {@code Player} using the {@link TeleportService2}.
 * @author Kill3r
 */
public class MovePlayerTo extends AdminCommand
{
	/**
	 * Initializes the {@link MovePlayerTo} admin command.<br>
	 * This allows administrators to teleport players to specific coordinates.
	 */
	public MovePlayerTo()
	{
		super("moveplayerto");
	...
	/**
	 * Teleports a specific player to a designated location.<br>
	 * It accepts either coordinates or a predefined map name as parameters.<br>
	 * The method validates the input and sends a confirmation message to the admin.
	 * @param player The admin player executing the command.
	 * @param params Variable arguments containing the target player name, world ID, coordinates, or map name.
	 */
	@Override
