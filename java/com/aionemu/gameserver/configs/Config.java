...
/**
 * This class serves as the central manager for all game server configurations.<br>
 * It provides access to various configuration modules like {@link BaseConfig} and {@link NetworkConfig}.<br>
 * Use this class to retrieve global settings used throughout the application.
...
public class Config
{
	 ...
	 * It applies overrides from {@code mygs.properties} if they exist.<br>
	...
	/**
	 * Reloads all server configuration files from the disk.<br>
	 * This method refreshes settings for both administration and main categories.<br>
	 * It applies overrides from {@code mygs.properties} if they exist.
	 */
