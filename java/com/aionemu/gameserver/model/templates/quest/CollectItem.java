...
/**
 * Represents a quest objective that requires the player to collect a specific item.<br>
 * This class defines the requirements and conditions for completing an item collection task.
 * @author MrPoke
 */
