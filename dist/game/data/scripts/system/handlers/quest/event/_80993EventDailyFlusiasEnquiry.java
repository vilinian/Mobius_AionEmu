...
/**
 * Handles the logic for the daily event quest "Flusias Enquiry".<br>
...
public class _80993EventDailyFlusiasEnquiry extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the daily Flusias Enquiry event.<br>
	 * This constructor sets up the quest with ID {@code 80993}.<br>
