...
/**
 * Handles the logic for spawning a totem-style servant as part of a skill effect.<br>
 * It manages the creation and positioning of the {@link Servant} object using the {@link SpawnEngine}.
 * @author kecimis
 * @reworked Kill3r
 */
