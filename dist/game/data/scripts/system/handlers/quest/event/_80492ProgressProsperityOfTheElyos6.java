...
/**
 * Handles the progress logic for quest {@code 80492} during the "Prosperity of the Elyos" sequence.<br>
 * This class manages specific event triggers and state transitions for step {@code 6}.
...
public class _80492ProgressProsperityOfTheElyos6 extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for Prosperity of the Elyos.<br>
	 * This constructor sets the {@code questId} to {@code 80492}.<br>
