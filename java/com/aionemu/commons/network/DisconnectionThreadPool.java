...
/**
 * This class manages a thread pool dedicated to executing {@code DisconnectionTask} instances.<br>
 * It ensures that disconnection logic is handled asynchronously to prevent blocking the main network threads.
 * @author -Nemesiss-
 */
