...
/**
 * This packet sends information about alliance members to the client.<br>
 * It contains data regarding {@link PlayerAllianceMember} objects within an alliance.
...
public class SM_ALLIANCE_MEMBER_INFO extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_ALLIANCE_MEMBER_INFO} packet.<br>
	 * This packet contains data about an alliance member during a specific event.<br>
	 * It extracts the player, alliance ID, and object ID from the provided member.
	 * @param member The {@link PlayerAllianceMember} containing the member details.
	 * @param event The {@link PlayerAllianceEvent} associated with this information.
	 */
	...
	protected void writeImpl(AionConnection con)
	{
		...
		final WorldPosition wp = player.getPosition();
