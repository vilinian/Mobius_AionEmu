...
/**
 * This class manages configuration settings specifically for developer tools.<br>
 * It allows administrators to toggle and tune internal features used during development.<br>
 * These properties are loaded from the server's configuration files.
 * @author ATracer
 */
public class DeveloperConfig
{
	...
	/**
	 * if Player Access Level is meet, display Packets-Name or Hex-Bytes in Chat Window Tip: Player Access-Level higher than or equal to 3 is recommended 10 - Server-Owner 9 - Server-CoOwner 8 - Server-Admin 7 - Server-CoAdmin 6 - Developer 5 - Admin 4 - Head-GM 3 - Senior-GM 2 - Junior-GM 1 - Supporter 0 - Players
	 */
