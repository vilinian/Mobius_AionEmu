...
/**
 * Handles the admin command to equip an item onto a player.<br>
 * This class allows administrators to manually assign {@link Item} objects to specific equipment slots.
 * @author Tago modified by Wakizashi
 */
public class Equip extends AdminCommand
{
	/**
	 * Initializes the {@link Equip} command.<br>
	 * This constructor registers the command with the name {@code equip}.
	 */
	public Equip()
	{
		super("equip");
	...
	/**
	 * Executes various equipment-related administrative commands.<br>
	 * This method handles actions like enchanting, socketing, and godstone application.<br>
	 * It also provides help messages for different command types.
	 * @param admin The {@code Player} who is running the command.
	 * @param params A variable list of strings containing the target player name and specific command arguments.
	 */
	@Override
	...
	/**
	 * Handles the process of adding or removing Manastones from a player's equipment.<br>
	 * It checks if the provided {@code manastone} ID is valid for a Manastone type.<br>
	 * If {@code manastone} is 0, it removes all stones from all upgradeable items.<br>
	 * Otherwise, it adds the specified quantity to available slots on equipped items.
	 * @param admin The administrator performing the action.
	 * @param player The target player whose equipment will be modified.
	 * @param manastone The ID of the Manastone to use, or 0 to remove all stones.
	 * @param quant The number of stones to add; if less than or equal to 0, it fills all available slots.
	 */
	...
	/**
	 * Handles the logic for adding or modifying a {@code GodStone} on a player's main hand weapon.<br>
	 * If the ID is high, it adds a new stone to the item.<br>
	 * If the ID is low, it updates the activation probability of the existing stone.
	 * @param admin The administrator performing the action.
	 * @param player The target player whose weapon is being modified.
	 * @param godstone The {@code ItemID} or probability value to apply.
	 */
	...
	/**
	 * This method enchants all upgradeable items on a player.<br>
	 * It checks for specific item limits like wings or bracelets.<br>
	 * The final enchantment level is capped based on the item template.<br>
	 * It updates the visual stats and sends confirmation messages to both players.
	 * @param admin The {@link Player} who executes the command.
	 * @param player The {@link Player} whose items will be enchanted.
	 * @param enchant The target enchantment level to apply.
	 */
	...
	/**
	 * Updates the enchantment level of all equipped plumes for a specific player.<br>
	 * The level is clamped between {@code 0} and {@code 20}.<br>
	 * It also updates the visual stats and sends notifications to both players.
	 * @param admin The administrator performing the action.
	 * @param player The target player whose equipment will be modified.
	 * @param plume The desired enchantment level for the plumes.
	 */
	...
	/**
	 * Amplifies a specific item for a player.<br>
	 * This method searches the {@code Player} equipment for an item with the given {@code itemId}.<br>
	 * It uses {@code Item)} to perform the action.<br>
	 * Success or failure messages are sent to both the {@code admin} and the {@code player}.
	 * @param admin The administrator performing the action.
	 * @param player The player whose item is being amplified.
	 * @param itemId The unique identifier of the item to amplify.
	 */
	...
	public static boolean isUpgradeble(Item item)
	{
		...
		if (item.getItemTemplate().isWeapon() || item.getItemTemplate().isAccessory())
		{
			return true;
		}
	...
	/**
	 * Calculates the maximum number of available slots for a specific item.<br>
	 * This method checks the {@code ItemQuality} and {@code ItemType} of the provided {@link Item}.<br>
	 * It returns the total count based on the game rules.
	 * @param item The {@link Item} to check for slot capacity.
	 * @return The maximum number of slots as an {@code int}.
	 */
	...
	/**
	 * Displays the help message for the {@code equip} command.<br>
	 * It informs the admin about available sub-commands and usage examples.
	 * @param admin The {@link Player} who will receive the help message.
	 */
	...
	/**
	 * Displays the usage instructions for the {@code enchant} command.<br>
	 * This message explains the syntax and target priority for administrators.
	 * @param admin The {@link Player} who will receive the help message.
	 */
	...
	/**
	 * Displays the help message for the plume enchantment command.<br>
	 * This informs the {@code Player} about the correct syntax and usage rules.
	 * @param admin The {@link Player} who executed the command.
	 */
	...
	/**
	 * Displays the help message for the socket command.<br>
	 * This informs the {@code admin} about the correct syntax and usage.<br>
	 * It explains how to use manastones and quantities with the {@code Player, int, int)} method.
	 * @param admin The player who executed the command.
	 */
	...
	/**
	 * Displays the help message for the godstone command.<br>
	 * It shows the correct syntax and usage rules to the {@code admin}.<br>
	 * This includes information on rates, IDs, and target priority.
	 * @param admin The {@link Player} who executed the command.
	 */
