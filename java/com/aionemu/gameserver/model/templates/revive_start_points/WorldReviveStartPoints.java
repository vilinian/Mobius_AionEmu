...
/**
 * This class manages the configuration for world revive start points.<br>
 * It defines where players can respawn based on their {@link Race}.
 * @author Falke_34
 */
...
public class WorldReviveStartPoints
{
	...
	/**
	 * Retrieves the maximum level allowed for this revive point.<br>
	 * This method returns the value stored in the {@code maxLevel} field.
	...
	/**
	 * Retrieves the minimum level required for this revive start point.<br>
	 * This value is used to check if a player meets the requirements.
