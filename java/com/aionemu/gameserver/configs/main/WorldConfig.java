...
/**
 * This class manages the global configuration settings for the game world.<br>
 * It provides access to various properties used by the {@code gameserver} to initialize environment variables.
 * @author ATracer
 */
