...
/**
 * This packet is used to send a list of achievement events to the client.<br>
 * It contains data regarding {@link PlayerAchievement} updates for the player.
 */
public class SM_ACHIEVEMENT_EVENT_LIST extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_ACHIEVEMENT_EVENT_LIST} packet.<br>
	 * This packet is used to send achievement events to a specific player.
	 * @param player The {@link Player} who will receive the achievement list.
	 */
