...
/**
 * Handles the logic for quest {@code 60204} Crazy Krall.<br>
...
public class _60204CrazyKrall extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for {@code 60204CrazyKrall}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 1, Count: 1, Mobs : 652958 // (1) Step: 1, Count: 1, Mobs : 212247 switch (var) { case 1: { return defaultOnKillEvent(env, 652958, 1, 2, 0); } case 1: { qs.setQuestVar(2); qs.setStatus(QuestStatus.REWARD); updateQuestStatus(env); return true; } default: break; } return false; } return false; }
	 */
}
