 ...
 * It contains common properties shared by every {@link Spawn} entity.
 * @author Source
 */
...
public class BaseSpawn
{
	...
	/**
	 * Retrieves the list of base race templates for this spawn.<br>
	 * This method returns the {@code simpleRaceTemplates} field.
	 * @return a {@code List} of {@code SimpleRaceTemplate} objects.
	 */
