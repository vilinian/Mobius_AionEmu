...
/**
 * Defines the set of available commands for the Game Master (GM) panel.<br>
 * This enum is used to map user inputs to specific server actions.
 * @author Ever' - Magenik
 */
public enum GmPanelCommands
{
	...
	/**
	 * Retrieves a {@link GmPanelCommands} constant based on a string name.<br>
	 * The input string is converted to uppercase before comparison.<br>
	 * This method throws an exception if the command is not found.
	 * @param command The string name of the command to look up.
	 * @return The corresponding {@code GmPanelCommands} enum value.
	 */
