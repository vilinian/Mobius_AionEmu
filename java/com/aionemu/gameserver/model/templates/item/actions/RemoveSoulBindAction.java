...
/**
 * Handles the logic for removing a soul bind from an {@link Item}.<br>
 * This action allows players to unbind their souls from specific equipment.<br>
 * It updates the item state and notifies the player via {@link SM_SYSTEM_MESSAGE}.
 * @author Falke34
 */
...
public class RemoveSoulBindAction extends AbstractItemAction
{
	 ...
	 * It ensures the target is soul bound and the player is not in attack mode.
	...
	/**
	 * Executes the action to remove a soul bind from an item.<br>
	 * This method handles the logic when a {@link Player} uses an item to unbind another.
