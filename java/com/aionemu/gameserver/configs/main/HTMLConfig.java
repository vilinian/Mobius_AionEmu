...
/**
 * This class manages the configuration settings for {@code HTML} related features.<br>
 * It provides a centralized way to access and modify web-based display properties.
 * @author lord_rex
 */
