...
/**
 * This class manages the configuration settings for the server shutdown process.<br>
 * It defines how the game server handles graceful exits and service termination.
 * @author lord_rex
 * @rework Blackfire
 */
