...
/**
 * Represents the data required for a quest objective involving killing spawned monsters.<br>
 * This model stores specific details related to {@link KillSpawned} requirements.
...
public class KillSpawnedData extends MonsterHuntData
{
	 ...
	 * It creates a new {@link KillSpawned} instance.<br>
	...
	{
		final Map<List<Integer>, SpawnedMonster> spawnedMonsters = new HashMap<>();
