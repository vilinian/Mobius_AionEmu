...
/**
 * Handles the client request to expand a cube.<br>
 * This packet triggers the {@link CubeExpandService} to process the expansion logic.
 * @author Eloann
 */
public class CM_EXPAND_CUBE extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_EXPAND_CUBE} packet.<br>
	...
	protected void runImpl()
	{
		...
		switch (action)
		{
			...
			case 1: // Cube Expansion Coin
				if (activePlayer.getCubeExpands() < 11)
				{
					// if less than 10 rows open / 117 slots
					if (activePlayer.getInventory().decreaseByItemId(186000444, 5))
					{
						// 117 slots to 126 [EU Always 5-Keys Displayed ]
				...
				else if (activePlayer.getCubeExpands() == 11)
				{
					// 11 rows open
					if (activePlayer.getInventory().decreaseByItemId(186000444, 5))
					{
				...
				else if (activePlayer.getCubeExpands() == 12)
				{
					// 12 rows open
					if (activePlayer.getInventory().decreaseByItemId(186000444, 5))
					{
				...
				else if (activePlayer.getCubeExpands() == 13)
				{
					// 13 rows open
					if (activePlayer.getInventory().decreaseByItemId(186000444, 5))
					{
				...
				else if (activePlayer.getCubeExpands() == 14)
				{
					// 14 rows open
					if (activePlayer.getInventory().decreaseByItemId(186000444, 5))
					{
