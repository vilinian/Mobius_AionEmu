...
/**
 * This class provides the database access layer for managing player game statistics using {@code MySQL5}.<br>
 * It extends {@link PlayerGameStatsDAO} to handle specific queries and data persistence for player records.
 * @author Glass
 * @modify xXMashUpXx
...
public class MySQL5PlayerGameStatsDAO extends PlayerGameStatsDAO
{
	...
	/**
	 * Saves the game statistics of a {@link Player} to the database.<br>
	 * This method uses the {@code INSERT_QUERY} to store all current stats.<br>
	 ...
	 */
	@Override
	public void insertPlayerGameStat(Player player)
	{
		Connection con = null;
		try
		{
	...
	/**
	 * Removes the game statistics for a specific player from the database.<br>
	 * This method uses the {@code DELETE_QUERY} to find the record matching the ID.<br>
	 * If an error occurs, it logs the exception details.
	 * @param playerId The unique identifier of the player whose stats should be removed.
	 */
	@Override
	public void deletePlayerGameStat(int playerId)
	{
		Connection con = null;
		try
		{
	...
	/**
	 * Updates the game statistics for a specific player in the database.<br>
	 * This method saves all current stats from the {@link Player} object to the SQL table.<br>
	 * It handles the connection and executes the update query automatically.
	 * @param player The {@code Player} object containing the updated statistics.
	 */
	@Override
	public void updatePlayerGameStat(Player player)
	{
		Connection con = null;
		try
		{
