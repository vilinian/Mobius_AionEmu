...
/**
 * This class manages the configuration settings for game legions.<br>
 * It provides a structured way to access and modify legion-related properties.<br>
 * Use this class to handle all data related to {@code Legion} entities.
 * @author Simple
 */
