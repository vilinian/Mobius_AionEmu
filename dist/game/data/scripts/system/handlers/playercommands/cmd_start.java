...
/**
 * Handles the {@code /start} player command.<br>
 * This class processes requests to initiate specific game actions or sequences.<br>
 * It extends {@link PlayerCommand} to manage input from players.
 * @author Maestross
 */
public class cmd_start extends PlayerCommand
{
	/**
	 * Initializes the {@code execute} method for the start command.<br>
	 * This sets up the basic configuration for the command.
	 */
	public cmd_start()
	{
		super("start");
	...
	/**
	 * Grants specific items to a player based on their character class.<br>
	 * The method checks the {@code PlayerClass} of the provided {@link Player}.<br>
	 * It then uses {@code int, int)} to give the corresponding rewards.
	...
	public void execute(Player player, String... params)
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> player.setCommandUsed(false), 500 * 500 * 100000);
