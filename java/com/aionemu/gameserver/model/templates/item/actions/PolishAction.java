...
/**
 * Handles the logic for polishing an item using a specific stone.<br>
 * This action processes the transformation of the {@code IdianStone} and applies bonuses to the target {@link Item}.
 * @author Rolandas
 * @author GiGatR00n
 */
...
public class PolishAction extends AbstractItemAction
{
	 ...
	 * It checks item levels, tuning status, and player state.
	...
	/**
	 * Executes the polishing action for an item.<br>
	 * This method handles the logic when a {@link Player} uses a polish item on a target.
