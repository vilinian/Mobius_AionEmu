...
/**
 * Handles the client request to invite a player to a group.<br>
 * This packet processes the invitation logic and communicates with {@link PlayerGroupService}.
...
public class CM_INVITE_TO_GROUP extends AionClientPacket
{
	...
	/**
	 * This method creates a new {@code CM_INVITE_TO_GROUP} packet.<br>
	 * It initializes the packet with specific network states.<br>
	 * Use this constructor to build an invitation for joining a group.
