...
/**
 * This class manages the configuration settings for the server's logging system.<br>
 * It handles properties related to log levels and file outputs for {@code main}.
 */
