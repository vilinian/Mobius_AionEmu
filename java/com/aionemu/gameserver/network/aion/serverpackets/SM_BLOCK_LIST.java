...
/**
 * This packet is sent to a player to provide their current block list.<br>
 * It contains information regarding all {@link BlockList} entries associated with the user.
 * @author Ben
 */
