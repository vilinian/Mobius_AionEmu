...
/**
 * Handles the admin command to remove a ban from a player's account.<br>
 * It identifies the target user and updates their status in the database.
 * @author Watson
 */
public class UnBan extends AdminCommand
{
	/**
	 * Initializes a new instance of the {@link UnBan} command.<br>
	 * This class handles the logic for removing a ban from a player account.
	 */
	public UnBan()
	{
		super("unban");
	...
	/**
	 * Executes the command to remove a ban from a specific player.<br>
	 * It identifies the player by name and determines the ban type based on provided parameters.
