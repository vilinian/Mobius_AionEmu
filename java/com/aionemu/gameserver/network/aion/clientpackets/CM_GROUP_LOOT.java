...
/**
 * Handles the client request to distribute loot among group members.<br>
 * This packet triggers the {@link DropDistributionService} to process shared items.
 * @author Rhys2002
 */
public class CM_GROUP_LOOT extends AionClientPacket
{
	...
	/**
	 * This method initializes a new {@link CM_GROUP_LOOT} packet.<br>
