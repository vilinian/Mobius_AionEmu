...
/**
 * Defines the various types of magic boost effects available in the game.<br>
 * This enumeration is used to categorize different magical enhancements for character stats.
 * @author ATracer
 */
public enum MAGIC_BOOST
{
	...
	/**
	 * Initializes the boost value for a specific class.<br>
