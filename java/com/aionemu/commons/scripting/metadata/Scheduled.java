...
/**
 * This annotation is applied to {@code Runnable} classes within scripts.<br>
 * All scheduled tasks are automatically cancelled when the script context is unloaded.<br>
 * Loading and unloading behavior is managed by {@link com.aionemu.commons.scripting.classlistener.ScheduledTaskClassListener}.
 * @author SoulKeeper
 */
@Documented
...
public @interface Scheduled
{
	...
	/**
	 * Effective only in case if {@code value} has more than 1 element.<br>
