...
/**
 * Handles the movement packet sent by a client for a {@link Summon} entity.<br>
 * This packet is processed to update the position of the summon in the game world.<br>
 * It interacts with the {@link SummonMoveController} to validate and execute the move.
 * @author ATracer
 */
public class CM_SUMMON_MOVE extends AionClientPacket
{
	...
	/**
	 * Handles the movement packet for a summon.<br>
	...
	protected void runImpl()
	{
		...
		if ((summon == null) || summon.getEffectController().isAbnormalState(AbnormalState.CANT_MOVE_STATE) || summon.getEffectController().isUnderFear())
		{
			return;
		}
