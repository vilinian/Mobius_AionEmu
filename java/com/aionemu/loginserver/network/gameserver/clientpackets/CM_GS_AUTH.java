...
/**
 * This class represents an authentication packet sent from the Game Server to the Login Server.<br>
 * It is used during the registration process to verify credentials.
 * @author -Nemesiss-
 */
