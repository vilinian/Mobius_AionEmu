...
/**
 * This class manages the configuration settings for the {@code ConquerorProtector} system.<br>
 * It defines how protection rules are applied to specific game entities and areas.
 * @Author Elo
 */
