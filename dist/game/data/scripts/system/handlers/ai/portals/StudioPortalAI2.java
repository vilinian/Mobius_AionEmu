...
/**
 * Handles the artificial intelligence for studio portal objects.<br>
 * It manages player interactions and teleportation logic via {@link TeleportService2}.<br>
 * This class ensures that players can correctly enter housing instances.
 * @author Rolandas
 */
@AIName("studioportal")
