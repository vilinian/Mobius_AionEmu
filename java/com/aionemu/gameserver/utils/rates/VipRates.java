...
/**
 * This class manages the specific rate multipliers for VIP players.<br>
 * It extends {@link Rates} to provide specialized values for premium accounts.
 * @author ATracer
...
public class VipRates extends Rates
{
	...
	/**
	 * Gets the current experience point rate for VIP players.<br>
	 * This value combines the base {@code RateConfig.VIP_XP_RATE} with any active holiday bonuses.
	...
	/**
	 * Retrieves the current drop rate for VIP players.<br>
	 * This value combines the base {@code RateConfig.VIP_DROP_RATE} with any active holiday bonuses.
	...
	/**
	 * Retrieves the current loss rate for VIP players.<br>
	 * This value is calculated using {@code RateConfig.VIP_AP_PLAYER_LOSS_RATE}.<br>
	 * It also includes any active holiday bonuses.
