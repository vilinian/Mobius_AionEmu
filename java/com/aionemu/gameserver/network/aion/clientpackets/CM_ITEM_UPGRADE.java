...
/**
 * Handles the client request to upgrade an item.<br>
 * This packet processes the logic for improving an {@link Item} using the {@link ItemUpgradeService}.
 * @author FinalNovas
 * @rework Navyan
 * @rework Blackfire
 */
public class CM_ITEM_UPGRADE extends AionClientPacket
{
	...
	/**
	 * This constructor initializes a new {@link CM_ITEM_UPGRADE} packet.<br>
	 * It sets the basic network properties for the packet.
	...
	{
		final Player player = getConnection().getActivePlayer();
		if ((player == null) || !ItemUpgradeService.checkItemUpgrade(player, baseItem, resultItemId))
		{
			return;
		}
