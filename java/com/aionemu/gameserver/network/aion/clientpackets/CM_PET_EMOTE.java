...
/**
 * Handles the client request to perform an emote with a {@link Pet}.<br>
 * This packet processes the action and triggers the corresponding {@link SM_PET_EMOTE} response.
 * @author ATracer
 * @author update Ever'
 */
public class CM_PET_EMOTE extends AionClientPacket
{
	...
	/**
	 * This method creates a new {@link CM_PET_EMOTE} packet.<br>
	...
	protected void runImpl()
	{
		...
		// Sometimes the client sends -2.4457384E7 as a Z coordinate, which could be a client bug or a packet issue caused by flying randomly and falling from a great height before resuming flight.
		if ((pet == null) || (x1 < 0) || (y1 < 0) || (z1 < 0))
		{
			return;
		}
