...
/**
 * Handles the logic for quest {@code 70305} Secret of Subterranea.<br>
 * This class manages specific quest progression and interactions within the Gelkmaros region.
...
public class _70305SecretOfSubterranea extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for {@code 70305SecretOfSubterranea}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 3, Count: 1, Mobs : 650305 // (1) Step: 6, Count: 1, Mobs : 653581 switch (var) { case 3: { return defaultOnKillEvent(env, 650305, 3, 4, 0); } case 6: { qs.setQuestVar(7); qs.setStatus(QuestStatus.REWARD); updateQuestStatus(env); return true; } default: break; } return false; } return false; }
	 */
}
