...
/**
 * Handles the specific quest event for the destruction of the Hell Pass.<br>
 * This class manages the logic triggered when players interact with this objective.<br>
...
public class _80992EventDestructionOfHellPass extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for event {@code 80992}.<br>
