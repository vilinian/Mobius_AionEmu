...
/**
 * Manages the logic for dynamic flags within the game world.<br>
 * This service handles updates and interactions related to {@link Npc}, {@link VisibleObject}, and {@link Player} entities.
 */
public class DynamicFlagService
{
	...
	/**
	 * Gets the single instance of the {@link DynamicFlagService}.<br>
	 * This method follows the singleton pattern.<br>
	 * Use this to access the global service for managing dynamic flags.
	 * @return The active {@code DynamicFlagService} instance.
	 */
