...
/**
 * This class is responsible for loading and storing {@link Player} data in the database.<br>
 * It provides the necessary methods to manage player records throughout the game server.
...
public abstract class PlayerDAO implements IDFactoryAwareDAO
{
	 ...
	 * @return List of IDs
	 */
	public abstract Set<Integer> getInactiveAccounts(int daysOfInactivity, int limitation);
	
	public abstract void setPlayerLastTransferTime(int playerId, long time);
	
	public abstract boolean updateBonusTime(int playerObjId);
