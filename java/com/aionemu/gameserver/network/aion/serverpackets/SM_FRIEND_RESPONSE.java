...
/**
 * This packet handles the server response for requests to add or remove friends.<br>
 * It informs the client whether the requested friendship action was successful.
 * @author Ben
 */
public class SM_FRIEND_RESPONSE extends AionServerPacket
{
	...
	/**
	 * Creates a new {@link SM_FRIEND_RESPONSE} packet.<br>
	 * This packet handles the result of a friend request action.
	 * @param playerName The name of the player involved in the request.
	 * @param messageType The specific status code for the response.
	 */
