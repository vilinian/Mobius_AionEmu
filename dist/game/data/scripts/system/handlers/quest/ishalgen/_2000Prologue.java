...
/**
 * This class handles the logic for the {@code 2000 Prologue} quest.<br>
 * It manages quest progression and triggers specific events for players.<br>
 * It extends {@link QuestHandler} to provide custom behavior for this specific quest.
 * @author MrPoke
 * @rework FrozenKiller
 */
public class _2000Prologue extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for quest {@code 2000}.<br>
