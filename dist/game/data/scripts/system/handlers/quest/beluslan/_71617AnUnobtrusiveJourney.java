...
/**
 * Handles the logic for the quest {@code 71617AnUnobtrusiveJourney}.<br>
...
public class _71617AnUnobtrusiveJourney extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for {@code 71617AnUnobtrusiveJourney}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 1, Count: 5, Mobs : 652105, 652106 // (1) Step: 1, Count: 5, Mobs : 652107, 652108 switch (var) { case 1: { // ??? } case 1: { // ??? } default: break; } return false; } return false; }
	 */
}
