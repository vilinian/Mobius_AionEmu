...
/**
 * This class manages the configuration settings for the server's cleaning system.<br>
 * It defines how the game world handles automated cleanup tasks and object removal.
 * @author nrg
 */
public class CleaningConfig
{
	...
	/**
	 * Maximum amount of chars deleted at one execution If too many chars are deleted in one run your database will get strongly fragmented which increases runtime dramatically Note: 0 for not limitation
	 */
