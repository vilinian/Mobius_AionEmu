...
/**
 * This effect ensures that an attack is always blocked.<br>
 * It prevents the target from receiving damage or being affected by specific actions.<br>
 * Use this when a skill should provide absolute protection against incoming hits.
 * @author ATracer
 */
