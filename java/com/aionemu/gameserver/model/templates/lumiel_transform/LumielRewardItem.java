...
/**
 * Represents an item rewarded to players during the {@code LumielTransform} process.<br>
 * This class holds the data for specific rewards defined in the game configuration.
 */
