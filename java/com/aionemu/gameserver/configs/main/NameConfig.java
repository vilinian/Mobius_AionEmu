...
/**
 * This class manages the configuration settings for naming rules within the game server.<br>
 * It provides methods to handle and validate player or entity names based on defined patterns.
 * @author nrg
 */
