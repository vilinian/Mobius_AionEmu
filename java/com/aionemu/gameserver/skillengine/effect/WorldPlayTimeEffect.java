...
/**
 * Handles the logic for displaying world playtime information.<br>
 * This effect sends a {@code SM_WORLD_PLAYTIME} packet to players.<br>
 * It is used to notify users of their current session duration.
 */
