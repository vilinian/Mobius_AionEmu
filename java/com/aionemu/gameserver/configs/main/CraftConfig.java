...
/**
 * This class manages the configuration settings for the crafting system.<br>
 * It provides access to various properties used to define crafting mechanics and requirements.
 */
