...
/**
 * This packet handles the synchronization of house objects for players.<br>
 * It informs the client about {@link HouseObject} data within a specific {@link House}.
 * @author Rolandas
 */
public class SM_HOUSE_OBJECT extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_HOUSE_OBJECT} packet.<br>
	 * This constructor initializes the packet with a specific house object.
	 * @param owner The {@link HouseObject} that this packet will represent.
	 */
