...
/**
 * This class is the main entry point for the application.<br>
 * It represents the entire game server and manages its core lifecycle.<br>
 * The {@code main} method is used to initialize and start the server.
 * @author -Nemesiss-
 * @author SoulKeeper
 * @author cura
...
public class GameServer
{
	...
	public static void main(String[] args)
	{
		...
		final GameEngine[] worldEngines = new GameEngine[]
		{
			WorldEngine.getInstance()
		};
		...
		// This loads only siege location data, not siege schedules or spawns.
	...
	/**
	 * Initializes and starts the network servers.<br>
	 * This method sets up the {@code NioServer} and connects the {@link LoginServer}.<br>
	 * It also initializes various banned manager instances.
	 */
	...
	/**
	 * Sets up the core system services and configuration files.<br>
	 * This method initializes the {@code CronService}, database factories, and thread pools.<br>
	 * It also loads global configurations like {@code Config} and {@code ThreadConfig}.
	 */
	...
	/**
	 * Registers a new {@code StartupHook} to be executed during the server startup process.<br>
	 * If no other hooks exist, the provided hook will run immediately.<br>
	 * This method is thread-safe and uses synchronization to manage the internal list of hooks.
	 * @param hook The {@code StartupHook} instance to register.
	 */
	...
	/**
	 * Executes all registered startup hooks.<br>
	 * This method is called during the server initialization process.<br>
	 * It iterates through the {@code startUpHooks} set and calls {@code onStartup}.
	 */
