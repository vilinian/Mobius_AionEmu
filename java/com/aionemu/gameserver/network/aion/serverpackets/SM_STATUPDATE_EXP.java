...
/**
 * This packet updates the character's experience point statistics.<br>
 * It synchronizes the current, recoverable, and maximum {@code exp} values with the client.
 * @author Luno
 * @updated by alexa026
 */
public class SM_STATUPDATE_EXP extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_STATUPDATE_EXP} packet.<br>
	 * This updates the experience and energy values for a character.
	 * @param currentExp The current amount of experience points.
	 * @param recoverableExp The amount of experience that can be recovered.
	 * @param maxExp The maximum possible experience points.
	 * @param curBoostExp The current boosted experience value.
	 * @param maxBoostExp The maximum boosted experience value.
	 * @param goldenStarEnergy The current Golden Star Energy amount.
	 * @param growthEnergy The current Energy of Growth amount.
	 */
