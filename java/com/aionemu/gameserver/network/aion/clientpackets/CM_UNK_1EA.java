...
/**
 * This class handles the {@code CM_UNK_1EA} client packet.<br>
 * It serves as a placeholder for an unknown or undocumented packet type received from the client.
 * @author Falke_34
 */
public class CM_UNK_1EA extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of {@code CM_UNK_1EA}.<br>
