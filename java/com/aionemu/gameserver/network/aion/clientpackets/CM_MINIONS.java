...
/**
 * Handles client-to-server packets related to minion management.<br>
 * This class processes requests from the {@link Player} regarding their minions.<br>
 * It interacts with the {@link MinionService} to execute various minion actions.
 * @author Falke_34, FrozenKiller
 */
public class CM_MINIONS extends AionClientPacket
{
	private final ArrayList<Integer> sacrificeMinions = new ArrayList<>();
	...
	/**
	 * Creates a new instance of the {@link CM_MINIONS} packet.<br>
