...
/**
 * This class handles the {@code CM_MAC_ADDRESS} packet sent by the client.<br>
 * It contains the MAC address information provided by the client during connection.<br>
 * The server uses this data to check for hardware-based bans via {@link BannedMacManager}.
 * @author -Nemesiss-, KID
 */
public class CM_MAC_ADDRESS extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_MAC_ADDRESS} packet.<br>
	 ...
	 * @param restStates Additional optional states for the packet.
	 */
