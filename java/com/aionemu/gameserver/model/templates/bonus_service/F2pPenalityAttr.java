...
/**
 * This class defines the attributes used to calculate penalties for Free-to-Play (F2P) players.<br>
 * It stores specific modifiers that affect character stats based on account status.
 */
