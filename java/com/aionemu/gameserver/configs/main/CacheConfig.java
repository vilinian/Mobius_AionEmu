...
/**
 * This class manages the configuration settings for the game cache system.<br>
 * It provides access to various properties used to handle cached data for {@link Account} and {@link Player} objects.
 * @author Luno
 */
public class CacheConfig
{
	/**
	 * Says whether cache for such things like PlayerCommonData or Appereance etc is cached in WeakCacheMap or in SoftCacheMap
	 */
