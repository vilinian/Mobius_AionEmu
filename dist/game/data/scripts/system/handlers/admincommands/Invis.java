...
/**
 * Handles the admin command to toggle a player's invisibility status.<br>
 * It manages {@link CreatureVisualState} updates and synchronizes changes via {@link SM_PLAYER_STATE}.
 * @author Divinity
 */
public class Invis extends AdminCommand
{
	/**
	 * Initializes a new instance of the {@link Invis} command.<br>
	 * This class handles the invisibility admin command.
	 */
	public Invis()
	{
		super("invis");
	...
	/**
	 * Toggles the invisibility state for a player.<br>
	 * It checks if the player is already hidden and switches their visual state accordingly.<br>
	 * The method sends a broadcast packet to update other players and notifies the user.
	 * @param player The {@code Player} who is executing the command.
	 * @param params Variable arguments for additional command parameters.
	 */
	@Override
