...
/**
 * This class handles damage modifications based on the target's race.<br>
 * It allows skills to apply specific multipliers when hitting a {@link Race}.<br>
 * It extends {@link ActionModifier} to integrate with the skill engine.
