...
/**
 * This class handles the logic for experience point (XP) boost effects.<br>
 * It allows players to receive a multiplier or bonus to their earned experience.<br>
 * It extends {@link BuffEffect} to integrate with the existing skill engine.
 * @author antness
 */
