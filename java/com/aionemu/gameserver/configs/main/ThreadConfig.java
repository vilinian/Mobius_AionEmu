...
/**
 * This class manages the configuration settings for the server's threading system.<br>
 * It allows you to define how many threads are allocated for various game tasks.<br>
 * Use this class to tune performance and stability across different hardware environments.
 * @author lord_rex
...
public class ThreadConfig
{
	...
	/**
	 * Calculates the total thread pool size based on configuration.<br>
	 * It uses {@code BASE_THREAD_POOL_SIZE} and {@code EXTRA_THREAD_PER_CORE}.<br>
	 * The result is multiplied by the number of available processors.
	 */
