...
/**
 * This class manages the configuration settings for in-game events.<br>
 * It provides a centralized way to load and access event-related properties from the server configuration files.
 * @author Rolandas
 */
