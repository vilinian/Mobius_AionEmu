...
/**
 * This class represents the execution environment for scripts.<br>
 * It manages the lifecycle of scripts including loading and unloading operations.
 */
public interface ScriptContext
{
	...
	/**
	 * Invokes {@code shutdown}, after that invokes {@code init}. Root folder remains the same, but new compiler and classloader are used.
	 */
	public void reload();
	...
	/**
	 * Adds child contexts to this context. If this context is initialized - chiled context will be initialized immideatly. In other case child context will be just added and initialized when {@code init} would be called. Duplicated child contexts are not allowed, in such case child will be ignored
