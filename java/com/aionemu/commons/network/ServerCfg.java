...
/**
 * This class holds the configuration settings for the {@link com.aionemu.commons.network.NioServer}.<br>
 * It defines how the server behaves and connects to the network.<br>
 * Use this class to manage global server parameters.
 * @author -Nemesiss-
...
public class ServerCfg
{
	...
	/**
	 * Creates a new instance of {@code ServerCfg}.<br>
	 * This constructor initializes the server configuration settings.
	 * @param hostName The name of the host to listen for connections.
	 * @param port The port number to listen for connections.
	 * @param connectionName A unique name used for logging purposes.
	 * @param factory The {@link ConnectionFactory} used to create new connections.
	 */
