...
/**
 * Handles the command for changing a player's current world channel.<br>
 * It validates permissions and updates the {@link Player} location accordingly.
 * @author Maestross
 */
public class cmd_world_channel extends PlayerCommand
{
	/**
	 * Initializes the world channel command.<br>
	 * This constructor sets up the {@link PlayerCommand} for the {@code world} action.
	 */
	...
	/**
	 * Executes the command to send a message to all players in the world.<br>
	 * It formats the message with an admin tag if applicable and checks for required AP costs.<br>
	 * The method handles broadcasting based on the player's GM status and prison state.
	 * @param player The {@code Player} executing the command.
	 * @param params Variable arguments containing the message text to be broadcasted.
	 */
	@Override
	public void execute(Player player, String... params)
	{
		int i = 1;
		final int ap = CustomConfig.WORLD_CHANNEL_AP_COSTS;
