...
/**
 * This class provides a custom implementation of {@code UncaughtExceptionHandler}.<br>
 * It handles exceptions that are not caught by any thread in the application.<br>
 * It ensures that errors are properly logged before a thread terminates.
 * @author -Nemesiss-
 */
