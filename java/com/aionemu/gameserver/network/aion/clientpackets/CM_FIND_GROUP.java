...
/**
 * Handles the client request to search for a group.<br>
 * This packet triggers the {@link FindGroupService} to process the user's query.
 * @author cura, MrPoke
 * @modified teenwolf
 */
public class CM_FIND_GROUP extends AionClientPacket
{
	...
	/**
	 * This method creates a new instance of the {@code CM_FIND_GROUP} packet.<br>
