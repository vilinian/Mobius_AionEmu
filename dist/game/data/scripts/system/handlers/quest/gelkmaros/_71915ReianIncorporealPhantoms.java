...
/**
 * Handles the quest logic for {@code 71915 Reian Incorporeal Phantoms}.<br>
...
public class _71915ReianIncorporealPhantoms extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for Reian Incorporeal Phantoms.<br>
	 * This constructor sets up the quest with ID {@code 71915}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 5, Mobs : 650154, 650155 // (1) Step: 0, Count: 5, Mobs : 650156, 650157 switch (var) { case 0: { // ??? } case 0: { // ??? } default: break; } return false; } return false; }
	 */
}
