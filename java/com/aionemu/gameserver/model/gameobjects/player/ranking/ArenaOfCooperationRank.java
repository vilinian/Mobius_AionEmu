...
/**
 * Represents the ranking data for a player in the Arena of Cooperation.<br>
...
public class ArenaOfCooperationRank
{
	...
	/**
	 * Creates a new instance of {@link ArenaOfCooperationRank}.<br>
	 * This constructor initializes all ranking and point statistics.
	 * @param rank The current rank of the player.
	 * @param bestRank The highest rank achieved by the player.
	 * @param points The current total points.
	 * @param lastPoints The points earned in the previous match.
	 * @param highPoints The maximum points ever reached.
	 * @param lowPoints The minimum points ever reached.
	 * @param possitionMatch The position achieved in the last match.
	 */
