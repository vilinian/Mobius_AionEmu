...
/**
 * Handles the logic for quest event {@code 80994} regarding securing the Hell Pass.<br>
 * This class manages specific player actions and state transitions within this quest sequence.
...
public class _80994EventSecuringHellPass extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for event {@code 80994}.<br>
