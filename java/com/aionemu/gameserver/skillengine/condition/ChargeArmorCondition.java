...
/**
 * This class checks if a player is currently wearing armor.<br>
 * It serves as a specific condition for skills that require the target to have armor equipped.
 * @author Rolandas
...
{
	/**
	 * Validates if the effector is wearing armor that can be charged.<br>
	 * This method updates the charge points of the first valid armor item found.<br>
	 * It returns {@code true} if an armor item was updated, otherwise it returns {@code false}.
