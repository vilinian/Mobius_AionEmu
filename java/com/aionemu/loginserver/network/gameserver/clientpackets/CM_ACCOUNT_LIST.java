...
/**
 * This packet handles requests to retrieve a list of account IDs currently logged into the game server.<br>
 * It allows the client to identify active accounts for administrative or monitoring purposes.
 * @author SoulKeeper
 */
