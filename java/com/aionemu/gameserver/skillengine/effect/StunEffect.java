...
/**
 * Represents a stun effect applied to a {@link Creature}.<br>
 * This effect immobilizes the target and prevents them from performing actions.<br>
 * It handles the logic for applying the {@code SM_TARGET_IMMOBILIZE} packet.
 * @author ATracer
 */
