...
/**
 * Handles the artificial intelligence for house gate NPCs.<br>
 * This class manages interactions such as teleporting players to their houses.<br>
 * It extends {@link NpcAI2} to process specific housing-related requests.
 * @author xTz, Rolandas
 */
@AIName("housegate")
public class HouseGateAI2 extends NpcAI2
{
	 ...
	 * It handles the logic for group members to enter or leave a house.<br>
	 * The method validates permissions and triggers the teleportation process.
	...
	protected void handleDialogStart(Player player)
	{
		...
		if ((house == null) || (house.getLevelRestrict() > player.getLevel())) // msg
		{
			return;
		}
		...
		AI2Actions.addRequest(this, player, SM_QUESTION_WINDOW.STR_ASK_GROUP_GATE_DO_YOU_ACCEPT_MOVE, 0, 9, new AI2Request()
		{
			...
			public void acceptRequest(Creature requester, Player responder)
			{
				...
				else
				{
					...
					responder.setBattleReturnCoords(responder.getWorldId(), new float[]
					{
						responder.getX(),
						responder.getY(),
						responder.getZ()
