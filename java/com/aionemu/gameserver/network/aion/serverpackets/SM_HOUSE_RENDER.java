...
/**
 * This packet handles the rendering of house objects for a client.<br>
 * It sends data regarding {@link House}, decorations, and other related entities to ensure they are displayed correctly in the game world.
 * @author Rolandas
 */
public class SM_HOUSE_RENDER extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_HOUSE_RENDER} packet for a specific house.<br>
	 * This packet is used to send house rendering data to the client.
	 * @param house The {@link House} object to be rendered.
	 */
