...
/**
 * Represents a chair object within the housing system.<br>
 * This class handles the behavior and properties of chairs used by players in their houses. It extends {@link HouseObject} using the {@code HousingChair} template.
 * @author Rolandas
 */
public class ChairObject extends HouseObject<HousingChair>
{
	/**
	 * Creates a new instance of a {@link ChairObject}.<br>
	 * This constructor initializes the chair with its owner and unique identifiers.
	 * @param owner The {@link House} that owns this object.
	 * @param objId The unique identifier for this specific object instance.
	 * @param templateId The ID of the furniture template used to create this chair.
	 */
