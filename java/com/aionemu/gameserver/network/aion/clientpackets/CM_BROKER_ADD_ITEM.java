...
/**
 * Handles the client request to add an item via the {@link BrokerService}.<br>
 * This packet processes requests where a player interacts with a broker to obtain items.
 * @author Lyras
 */
public class CM_BROKER_ADD_ITEM extends AionClientPacket
{
	...
	/**
	 * This method initializes a new {@code CM_BROKER_ADD_ITEM} packet.<br>
