...
/**
 * Handles the client request to delete a specific recipe.<br>
 * This packet is processed by the server to remove an item from the player's collection.
 * @author Rolandas
 */
public class CM_RECIPE_DELETE extends AionClientPacket
{
	...
	/**
	 * This constructor initializes a new {@code CM_RECIPE_DELETE} packet.<br>
