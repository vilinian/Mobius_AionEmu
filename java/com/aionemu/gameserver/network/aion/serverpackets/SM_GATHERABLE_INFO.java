...
/**
 * This packet provides information about gatherable objects in the game world.<br>
 * It is sent to clients to describe items that can be collected or harvested.
 * @author ATracer
 */
public class SM_GATHERABLE_INFO extends AionServerPacket
{
	...
	/**
	 * Creates a new {@link SM_GATHERABLE_INFO} packet.<br>
	 * This constructor initializes the packet with a specific object.
	 * @param visibleObject The {@code VisibleObject} to be included in the packet.
	 */
