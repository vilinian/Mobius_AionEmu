...
/**
 * This packet handles the synchronization of character fatigue data.<br>
 * It is used to update the client regarding current fatigue levels.
...
{
	private final int effectEnabled;
	private final int isFull;
	private final int fatigueRecover;
	private final int iconSet;
	
	/**
	 * Creates a new {@code SM_FATIGUE} packet.<br>
	 * This packet handles the fatigue status for players.
	 * @param effectEnabled The status of the fatigue effect.
	 * @param isFull Indicates if the fatigue bar is full.
	 * @param fatigueRecover The amount of fatigue recovered.
	 * @param iconSet The identifier for the icon set to display.
	 */
