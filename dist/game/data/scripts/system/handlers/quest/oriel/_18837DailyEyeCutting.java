...
/**
 * Handles the logic for the daily quest {@code 18837} regarding Eye Cutting.<br>
 * This class manages specific quest progression and interactions within the Oriel region.
...
public class _18837DailyEyeCutting extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the daily eye cutting task.<br>
	 * This constructor sets up the internal state using the quest ID {@code 18837}.
	 */
