...
/**
 * Defines the types of Earth Resistance stats available in the game.<br>
 * This enum is used to categorize different earth-related defensive properties.
 * @author ATracer
 */
public enum EARTH_RESIST
{
	...
	/**
	 * Initializes the resistance value for an {@link EARTH_RESIST} type.<br>
