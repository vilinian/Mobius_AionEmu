...
/**
 * This class handles the reward logic specifically for the Jormungand instance.<br>
 * It manages how {@link JormungandPlayerReward} objects are processed and distributed to players.
 * @author Falke_34
 */
public class JormungandReward extends InstanceReward<JormungandPlayerReward>
{
	...
	/**
	 * Creates a new {@code JormungandReward} object.<br>
	 * This constructor initializes the reward with default point values and time limits.<br>
	 * It sets the required points for winners, losers, and the cap.
	 * @param mapId The unique identifier for the map.
	 * @param instanceId The unique identifier for the specific instance.
	 * @param instance The {@link WorldMapInstance} where this reward is active.
	 */
	...
	{
		return getInstanceRewards().stream().mapToInt(JormungandPlayerReward::getPoints).max().orElse(0) >= capPoints;
	}
	
	/**
	 * Retrieves the reward for a specific player.<br>
	 * This method casts the result to a {@code JormungandPlayerReward}.
	 * @param object The unique identifier of the player.
	 * @return The {@code JormungandPlayerReward} associated with the provided object.
	 */
	@Override
	 ...
	 * @return A {@code List} of {@link JormungandPlayerReward} objects sorted by points in descending order.
	 */
	public List<JormungandPlayerReward> sortPoints()
	{
		return getInstanceRewards().stream().sorted(Comparator.comparingInt(JormungandPlayerReward::getScorePoints).reversed()).collect(Collectors.toList());
	}
	 ...
	 * If not, it adds a new {@code JormungandPlayerReward} to the list.
	...
	/**
	 * Adds a specific reward to the list of rewards.<br>
	 * This method calls the superclass implementation to register the {@code JormungandPlayerReward}.
	 * @param reward The {@code JormungandPlayerReward} object to be added.
	 */
	@Override
