...
/**
 * Represents the configuration for a {@code SiegeLocation} teleport point in Luna.<br>
 * This class defines the specific coordinates and properties required to handle player teleportation within this zone.
 */
...
public class LunaTeleport
{
	 ...
	 * This updates the {@code worldId} field of the {@link PortalLoc} object.
	 * @param value The new ID to assign to the world.
	 */
