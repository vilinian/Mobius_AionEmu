...
/**
 * This packet handles the retrieval of nearby quests for a player.<br>
 * It is sent from the server to the client to update the quest list UI.
...
public class SM_NEARBY_QUESTS extends AionServerPacket
{
	...
	/**
	 * Creates a new {@code SM_NEARBY_QUESTS} packet.<br>
	 * This method initializes the quest list for nearby objectives.
	 * @param nearbyQuestList A {@code HashMap<Integer, Integer>} containing the quest data.
	 */
