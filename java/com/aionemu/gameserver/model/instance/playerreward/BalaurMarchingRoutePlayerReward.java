...
/**
 * Represents the rewards granted to a {@link Player} for completing the Balaur Marching Route.<br>
...
public class BalaurMarchingRoutePlayerReward extends InstancePlayerReward
{
	...
	/**
	 * Creates a new {@link BalaurMarchingRoutePlayerReward} instance.<br>
	 ...
	 * @param race The {@link Race} type associated with this reward.
	 */
