...
/**
 * This class handles the {@code CM_GS_CHARACTER} packet sent from the game server to the client.<br>
 * It is used to synchronize character data between the server and the client during the login process.
 * @author cura
 */
