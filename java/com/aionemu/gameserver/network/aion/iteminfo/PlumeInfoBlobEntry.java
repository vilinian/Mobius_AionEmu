...
/**
 * Represents a specific entry within an {@link ItemInfoBlob} for plume data.<br>
 * This class handles the parsing and storage of information related to plumes.<br>
 * It extends {@link ItemBlobEntry} to provide specialized functionality for this item type.
 * @author Rinzler
 * @rework Ever'
 */
...
{
	/**
	 * Creates a new instance of {@code PlumeInfoBlobEntry}.<br>
	 * This class represents specific plume information within an {@link ItemInfoBlob}.<br>
	 * It initializes the entry with the {@code PLUME_INFO} type.
	 */
	PlumeInfoBlobEntry()
	{
