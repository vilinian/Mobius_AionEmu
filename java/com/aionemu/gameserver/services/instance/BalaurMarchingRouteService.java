...
/**
 * Manages the movement paths for {@link Player} entities during a Balaur marching event.<br>
 * It handles the logic for navigating specific routes within the game world.
 * @author Falke_34
 */
public class BalaurMarchingRouteService
{
	...
	/**
	 * Provides the global instance of the {@link BalaurMarchingRouteService}.<br>
	 * This method follows the singleton pattern.
	 * @return The single instance of {@code BalaurMarchingRouteService}.
	 */
	...
	/**
	 * Starts the Balaur Marching Route service.<br>
	 * This method schedules registration tasks based on {@code JORMUNGAND_TIMES}.<br>
	 * It uses {@link CronService} to run {@code startRegistration} at specific intervals.
	 */
	public void start()
	{
	...
	/**
	 * Initializes the registration process for the Balaur Marching Route instance.<br>
	...
	/**
	 * Schedules the unregistration process for the Balaur Marching Route instance.<br>
	...
	/**
	 * Checks if the Balaur Marching Route is currently open for registration.<br>
	 * This method returns {@code true} if players can join the instance.<br>
	 * It returns {@code false} if registration is closed.
