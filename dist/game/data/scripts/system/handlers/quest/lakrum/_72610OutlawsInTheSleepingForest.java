...
/**
 * Handles the logic for the quest {@code 72610 Outlaws In The Sleeping Forest}.<br>
...
public class _72610OutlawsInTheSleepingForest extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for {@code 72610OutlawsInTheSleepingForest}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 10, Mobs : 655253, 655060 if (var == 0 && var1 < 9) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(1); updateQuestStatus(env); } } return false; }
	 */
}
