...
/**
 * This packet handles the request from the {@code Aion} client to retrieve a list of characters.<br>
 * It is used during the login process to display available accounts to the user.
 * @author -Nemesiss-
 */
public class CM_CHARACTER_LIST extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_CHARACTER_LIST} packet.<br>
	 * This packet is used by the client to request a list of characters.
	 * @param opcode The unique identifier for this packet type.
	 * @param state The primary connection state associated with the request.
	 * @param restStates Additional states that may be required for processing.
	 */
