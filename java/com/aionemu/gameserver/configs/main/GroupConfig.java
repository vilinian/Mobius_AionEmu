...
/**
 * This class manages the configuration settings for various game groups.<br>
 * It provides a structured way to access group-specific properties within the {@code main} package.
 */
