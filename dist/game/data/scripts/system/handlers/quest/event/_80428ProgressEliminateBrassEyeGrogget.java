...
/**
 * Handles the progress logic for eliminating a Brass Eye Grogget.<br>
 * This class updates the quest state when the specific target is defeated.
...
public class _80428ProgressEliminateBrassEyeGrogget extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for progress in the Eliminate Brass Eye Grogget quest.<br>
