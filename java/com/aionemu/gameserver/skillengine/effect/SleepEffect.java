...
public class SleepEffect extends EffectTemplate
{
	 ...
	 * This method handles the logic for applying sleep states and canceling current skills.<br>
	 * It ensures the target is not in a resting state before application.
