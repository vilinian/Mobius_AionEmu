...
/**
 * Defines the types of random properties that can be applied to items.<br>
 * This enum is used by {@link com.aionemu.gameserver.model.templates.item.ItemTemplate} to determine how random attributes are handled.
 * @author vlog
...
public enum RandomType
{
	 ...
	 * This enum should not be created using {@code new}.
	 */
	private RandomType()
	{
	}
	...
	/**
	 * Creates a new {@link RandomType} with a specific level.<br>
	 * This constructor sets the internal level value for the enum constant.
	 * @param level The numeric level to assign to this type.
	 */
