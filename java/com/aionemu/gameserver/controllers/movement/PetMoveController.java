...
/**
 * Handles the movement logic specifically for {@link Pet} entities.<br>
 * It extends {@code CreatureMoveController} to provide specialized behavior for pets.
 * @author ATracer
 */
public class PetMoveController extends CreatureMoveController<Pet>
{
	...
	/**
	 * Initializes a new instance of the {@link PetMoveController}.<br>
	 * This constructor sets up the default state for pet movement.
	 */
