...
/**
 * This class manages the configuration settings for the game ranking system.<br>
 * It provides access to various properties used to define how rankings are displayed and calculated.
 * @author Sarynth
 */
