...
/**
 * Handles the logic for the daily quest {@code 18833} regarding Leafy Cutting.<br>
 * This class manages player interactions and progress requirements for this specific task.
...
public class _18833DailyLeafyCutting extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the daily leafy cutting task.<br>
	 * This constructor sets up the internal state using the unique {@code questId}.
	 */
