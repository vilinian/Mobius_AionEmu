...
/**
 * This class handles the {@code CM_MY_DOCUMENTATION} packet sent from the client.<br>
 * It is used to retrieve and display documentation information for the player.
 * @author Falke_34
 */
public class CM_MY_DOCUMENTATION extends AionClientPacket
{
	...
	/**
	 * This constructor initializes a new {@link CM_MY_DOCUMENTATION} packet.<br>
	 * It sets the required network properties for the packet.
