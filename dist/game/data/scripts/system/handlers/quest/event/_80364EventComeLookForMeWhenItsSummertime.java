...
/**
 * Handles the specific quest event for "Come Look For Me When It's Summertime".<br>
 * This class manages the logic triggered when a player interacts with this quest objective.
...
public class _80364EventComeLookForMeWhenItsSummertime extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for event {@code 80364}.<br>
