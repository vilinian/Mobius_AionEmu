...
/**
 * This class holds the data for achievement actions within the game server.<br>
 * It serves as a container for {@link AchievementActionTemplate} objects loaded from configuration files.
 */
...
public class AchievementActionData
{
	...
	@XmlTransient
	private final TIntObjectHashMap<AchievementActionTemplate> custom = new TIntObjectHashMap<>();
	
	/**
	 * Retrieves a specific achievement action template by its unique identifier.<br>
	 * This method looks up the ID in the {@code custom} map.
	 * @param id The unique integer ID of the achievement action.
	 * @return The corresponding {@link AchievementActionTemplate} object, or {@code null} if not found.
	 */
	 ...
	 * It populates the {@code custom} map using the list of {@link AchievementActionTemplate} objects.
	...
	/**
	 * Retrieves the internal map of custom achievement actions.<br>
	 * This method provides access to the {@code custom} collection.
	 * @return a {@link TIntObjectHashMap} containing {@link AchievementActionTemplate} objects.
	 */
