...
/**
 * Represents an instance of the Pandaemonium Battlefield managed by the {@link AutoGroupService}.<br>
 * This class handles specific logic for automated group instances within this game mode.
 * @author Falke_34
 */
public class AutoPandaemoniumBattlefieldInstance extends AutoInstance
{
	 ...
	 * It handles group creation or joining for the player based on current occupancy.<br>
	...
	public void onEnterInstance(Player player)
	{
		...
		final List<Player> playersInside = instance.getPlayersInside();
	...
	public void onPressEnter(Player player)
	{
		...
		if (agt.isPandaemoniumBattlefield())
		{
