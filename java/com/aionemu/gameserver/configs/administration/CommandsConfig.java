...
/**
 * This class manages the configuration settings for administrative commands.<br>
 * It provides a structured way to load and access command-related properties from the configuration files.
