...
/**
 * This class handles the localization settings for the {@code German} language.<br>
 * It provides the necessary translations and configurations for players using this locale.
 * @author Eloann
 * @reworked Voidstar
 */
...
{
	/**
	 * Initializes the German language handler.<br>
	 * This constructor sets up the {@code de} locale and adds supported translations.<br>
	 * It registers various system messages into the {@link Language} class.
	 */
	public German()
	{
		super("de");
