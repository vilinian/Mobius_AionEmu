...
/**
 * Handles the quest logic for "Unexplored Place in the Dragonfly Forest".<br>
...
public class _62515UnexploredPlaceInTheDragonflyForest extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for {@code 62515UnexploredPlaceInTheDragonflyForest}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 1, Count: 1, Mobs : 655309 if (var == 1 && var1 < 0) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(2); updateQuestStatus(env); } } return false; }
	 */
}
