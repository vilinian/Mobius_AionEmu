...
/**
 * Handles the administrative command to ban a player from the game.<br>
 * It processes the request and updates the {@link PlayerDAO} to restrict access.<br>
 * This class ensures that banned users cannot log into the server.
 * @author Watson
 */
public class Ban extends AdminCommand
{
	/**
	 * Creates a new instance of the {@link Ban} command.<br>
	 * This class handles the logic for banning players from the game.
	 */
	public Ban()
	{
		super("ban");
	...
	/**
	 * Executes the command to ban a player from the game.<br>
	 * It identifies the target by name and applies a ban based on the provided type and duration.
	 * @param admin The {@code Player} who is running the command.
	 * @param params A variable list of strings where the first element is the target name, followed by the ban type and time in minutes.
	 */
	@Override
