...
/**
 * Defines the different types of food available for pets.<br>
 * This enumeration is used to categorize pet consumables within the game system.
 * @author Rolandas
 */
...
public enum FoodType
{
	...
	/**
	 * Converts a string into its corresponding {@link FoodType}.<br>
	 * This method is useful for parsing data from external sources.
	 * @param value The string representation of the food type.
	 * @return The matching {@code FoodType} enum constant.
	 */
