...
/**
 * This packet handles the reception of whisper chat messages from the client.<br>
 * It processes private messages sent between players in the game world.
 * @author SoulKeeper
 */
public class CM_CHAT_MESSAGE_WHISPER extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_CHAT_MESSAGE_WHISPER} packet.<br>
