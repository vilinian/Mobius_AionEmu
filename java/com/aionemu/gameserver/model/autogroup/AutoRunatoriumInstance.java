...
/**
 * Represents an instance of the Runatorium specifically designed for automated group play.<br>
 * It manages the state and logic for {@link PlayerGroup} activities within this specific game mode.
