...
/**
 * Represents the unique identifiers for different character emotions.<br>
 * These IDs are used to trigger specific animations and expressions for both players and {@code NPC} entities.
...
public enum EmotionId
{
	...
	/**
	 * Creates a new {@link EmotionId} instance.<br>
	 * This constructor maps the internal integer value to an emotion type.
