...
/**
 * Handles the logic for using an enchantment glyph on an item.<br>
 * This action processes the application of enchantments and manages related effects like destruction or success.<br>
 * It interacts with {@link EnchantService} to perform the core enchantment mechanics.
 */
...
public class EnchantGlyphAction extends AbstractItemAction
{
	 ...
	 * It checks for sufficient Kinah, valid item types, and enchantment limits.
	...
	/**
	 * Executes the enchantment action on an item.<br>
	 * This method handles the logic when a {@link Player} uses a glyph to enchant a target item.
