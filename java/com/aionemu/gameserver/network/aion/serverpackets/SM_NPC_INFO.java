...
/**
 * This packet handles the display of visible {@link Npc} and monster entities to the client.<br>
 * It provides necessary information for rendering creatures in the game world.
 * @author -Nemesiss-
 */
public class SM_NPC_INFO extends AionServerPacket
{
	...
	/**
	 * Creates a new {@link SM_NPC_INFO} packet for a specific NPC.<br>
	 * This method initializes the data needed to show an NPC to a player.<br>
	 * It extracts information from the provided {@code npc} object.
	 * @param npc The {@link Npc} object containing the entity data.
	...
	/**
	 * Creates a new packet to display information about a summoned creature.<br>
	 * This constructor sets the NPC data based on the provided {@code Summon}.<br>
	 * It also determines if the summon is friendly or hostile relative to the {@link Player}.
	 * @param summon The {@code Summon} object containing the creature data.
	 * @param player The {@link Player} who will receive this packet.
	 */
	...
	/**
	 * Creates a new {@link SM_NPC_INFO} packet for an NPC.<br>
	 * This constructor initializes the packet with specific NPC data.<br>
	 * It sets the master name and retrieves the template information.
	 * @param npc The {@code Npc} object to include in the packet.
	 * @param master The name of the master associated with this NPC.
	 */
	...
	protected void writeImpl(AionConnection con)
	{
		...
		// Monster? No drop 3,19 - wings spread (NPCs).
