...
/**
 * Handles the logic for quest {@code 61604} regarding Lepharist Experiments.<br>
...
public class _61604LepharistExperiments extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for Lepharist Experiments.<br>
	 * This constructor sets up the quest with ID {@code 61604}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 1, Count: 3, Mobs : 652821 // (1) Step: 1, Count: 3, Mobs : 652822 switch (var) { case 1: { // ??? } case 1: { // ??? } default: break; } return false; } return false; }
	 */
}
