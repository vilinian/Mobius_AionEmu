...
/**
 * Handles the application of weapon mastery effects to a character.<br>
 * It calculates specific stat bonuses based on the {@link WeaponType} equipped by the player.
 * @author ATracer
 */
