...
/**
 * This class provides the English language localization for the game.<br>
 * It extends {@link Language} to handle specific text mappings and translations.
 * @author Eloann
 * @reworked Voidstar
 */
...
{
	/**
	 * Initializes the English language settings.<br>
	 * This constructor registers all required translations and supported codes for the {@link Language} class.
	 */
	public English()
	{
		super("en");
