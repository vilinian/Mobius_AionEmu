...
/**
 * This class represents the collection of items that can be used as feed materials.<br>
 * It maps specific {@code itemGroups} to their corresponding entries in the feeding system.
 * @author Rolandas
 */
