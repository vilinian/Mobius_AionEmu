...
/**
 * Handles the client message for entering or interacting with the Neviwind Canyon area.<br>
 * This packet processes requests sent from the {@code AionClient} to the server regarding this specific zone.
 * @author Falke_34
 */
public class CM_NEVIWIND_CANYON extends AionClientPacket
{
	...
	/**
	 * This constructor initializes a new {@link CM_NEVIWIND_CANYON} packet.<br>
