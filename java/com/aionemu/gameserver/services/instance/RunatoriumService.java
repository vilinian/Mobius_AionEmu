...
/**
 * Manages the logic and functionality for the {@code RunatoriumService} instance.<br>
 * This service handles specific game mechanics related to the runatorium area within the world.<br>
 * It interacts with {@link Player} objects and other game services to maintain state.
...
public class RunatoriumService
{
	...
	/**
	 * Provides the global access point for the {@link RunatoriumService}.<br>
	 * This method follows the singleton pattern.<br>
	 * It returns the single shared instance of the service.
	 * @return The active {@code RunatoriumService} instance.
	 */
	...
	/**
	 * Starts the Runatorium service by scheduling registration tasks.<br>
	 * It parses the cron expressions from {@code RUNATORIUM_TIMES}.<br>
	...
	public void start()
	{
		final String[] times = AutoGroupConfig.RUNATORIUM_TIMES.split("\\|");
	...
	/**
	 * Initializes the registration process for the Runatorium instance.<br>
	...
	/**
	 * Schedules the unregistration process for the Runatorium instance.<br>
	...
	/**
	 * Checks if the Runatorium is currently open for registration.<br>
