...
/**
 * This class defines the rewards granted to players upon completing specific achievement events.<br>
 * It serves as a data model for mapping event outcomes to various in-game prizes.
 */
...
public class AchievementEventRewards
{
	...
	/**
	 * Retrieves the current stage of the achievement.<br>
	 * This value is stored in the {@code stage} field.
	 * @return The integer value representing the stage.
	 */
