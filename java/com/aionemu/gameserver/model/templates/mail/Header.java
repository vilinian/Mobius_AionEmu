...
/**
 * Represents the header information for a mail template.<br>
 * This class holds metadata used to define how a mail is displayed or processed in the game.<br>
 * It maps directly to the {@code Header} XML element.
 * @author Rolandas
 */
...
public class Header extends MailPart
{
	 ...
	 * If no specific type is set, it returns {@code HEADER}.
