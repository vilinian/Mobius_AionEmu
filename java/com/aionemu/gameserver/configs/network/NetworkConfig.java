...
/**
 * This class manages the network configuration settings for the game server.<br>
 * It provides access to properties such as IP addresses and port numbers used by {@link InetSocketAddress}.
 */
