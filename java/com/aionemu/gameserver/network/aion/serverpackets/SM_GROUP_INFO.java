...
/**
 * This packet handles the transmission of group information to the client.<br>
 * It provides details about a {@link PlayerGroup} and its members.
...
public class SM_GROUP_INFO extends AionServerPacket
{
	...
	/**
	 * Creates a new {@link SM_GROUP_INFO} packet from a {@code PlayerGroup}.<br>
	 * This method extracts the necessary data to send group information to the client.
	 * @param group The {@code PlayerGroup} object containing the group details.
	 */
