...
/**
 * This class manages the configuration settings for geographical data.<br>
 * It provides access to properties related to world maps and coordinates.<br>
 * Use this class to load and retrieve {@code GeoData} parameters from the server configuration.
 */
