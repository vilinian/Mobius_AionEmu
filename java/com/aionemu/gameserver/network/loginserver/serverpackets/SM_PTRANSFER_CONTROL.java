...
/**
 * Handles the control logic for player character transfers.<br>
 * This packet manages the synchronization of data between characters during a transfer process.
 * @author KID
 */
public class SM_PTRANSFER_CONTROL extends LsServerPacket
{
	...
	/**
	 * Creates a new {@code SM_PTRANSFER_CONTROL} packet.<br>
	 * This constructor initializes the packet with a specific transfer type and task identifier.
	 * @param type The type of the transfer operation.
	 * @param taskId The unique identifier for the current task.
	 */
	...
	/**
	 * Creates a new {@code SM_PTRANSFER_CONTROL} packet for a player transfer.<br>
	 * This constructor initializes the packet using data from a {@link TransferablePlayer}.
	 * @param type The type of the transfer control packet.
	 * @param tp The {@link TransferablePlayer} object containing the player and task information.
	 */
	...
	/**
	 * Creates a new {@code SM_PTRANSFER_CONTROL} packet.<br>
	 * This constructor is used when a transfer result message is required.
	 * @param type The type of the transfer control.
	 * @param tp The {@link TransferablePlayer} involved in the transfer.
	 * @param result The resulting status or message of the transfer.
	 */
	...
	/**
	 * Creates a new {@code SM_PTRANSFER_CONTROL} packet with a specific task ID and result.<br>
	 * This constructor is used to send transfer status updates to the client.
	 * @param type The packet type identifier.
	 * @param taskId The unique identifier for the transfer task.
	 * @param result The message or status string returned by the operation.
	 */
	...
	protected void writeImpl(LoginServerConnection con)
	{
		...
		switch (type)
		{
			...
			case CHARACTER_INFORMATION:
			{
				...
				final List<QuestState> quests = new ArrayList<>();
