...
/**
 * Handles the quest logic for "Support Mission By The Lake Of Records".<br>
...
public class _72526SupportMissionByTheLakeOfRecords extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the mission "Support Mission By The Lake Of Records".<br>
	 * This constructor sets up the quest with the ID {@code 72526}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 10, Mobs : 655108, 655109, 655110, 655111 if (var == 0 && var1 < 9) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(1); updateQuestStatus(env); } } return false; }
	 */
}
