...
/**
 * Represents a collection of members belonging to the same group.<br>
 * This interface defines the core structure for managing {@link TeamMember} entities within the game world.
 * @author ATracer
 * @param <M>
 * @param <TM>
 */
