...
/**
 * This class manages the configuration settings for the auto-group system.<br>
 * It allows administrators to define rules and behaviors for automated group creation.<br>
 * You can use this class to customize how {@code AutoGroup} logic behaves on the server.
 * @author xTz
