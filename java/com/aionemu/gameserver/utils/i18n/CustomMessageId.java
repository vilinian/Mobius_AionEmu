...
/**
 * This class defines the unique identifiers for custom messages used in the game.<br>
 * It maps specific message types to their corresponding IDs for internationalization purposes.
 * @author Maestros
 * @co-author Voidstar
 */
public enum CustomMessageId
{
	...
	/**
	 * Creates a new instance of {@link CustomMessageId}.<br>
	 * This constructor sets the default message to use.
	 * @param fallbackMessage The text to display if no other message is found.
	 */
	...
	/**
	 * Retrieves the default message for this {@code CustomMessageId}.<br>
	 * This is used when a specific translation is missing.
	 * @return The raw string value of the fallback message.
	 */
	...
	/**
	 * Retrieves the master branding string for server messages.<br>
	 * This method checks the {@link NetworkConfig} to determine the return value.<br>
	 * It returns an empty string if the bind address is standard.<br>
	 * Otherwise, it returns the literal value {@code Emulator}.
	 * @return The branding string used in various system messages.
	 */
