...
/**
 * This packet handles the synchronization of equipment settings for a player.<br>
 * It allows the server to update the client on specific {@link EquipmentSetting} data.
 * @author FrozenKiller
 */
public class SM_EQUIPMENT_SETTING extends AionServerPacket
{
	...
	/**
	 * Creates a new {@link SM_EQUIPMENT_SETTING} packet.<br>
	 * This constructor initializes the packet with a list of equipment settings.
	 * @param equipmentSetting The collection of {@link EquipmentSetting} objects to include in the packet.
	 */
