...
/**
 * Manages the logic and mechanics for the Golden Crucible instance.<br>
 * This service handles specific game rules, events, and player interactions within this area.
 * @author Falke_34
 */
public class GoldenCrucibleService
{
	 ...
	 * Use this method to access the {@link GoldenCrucibleService} globally.
	 * @return The single shared instance of {@code GoldenCrucibleService}.
	 */
	...
	/**
	 * Starts the Golden Crucible service.<br>
	 * This method schedules registration tasks based on the cron expressions defined in {@link AutoGroupConfig}.<br>
	 * It uses {@link CronService} to manage these scheduled events.
	 */
	public void start()
	{
		final String[] times = AutoGroupConfig.GOLDENCRUCIBLE_TIMES.split("\\|");
	...
	/**
	 * Checks if the Golden Crucible is currently open for registration.<br>
