...
/**
 * Handles the quest logic for "Support Mission In The Ancient Redwood Forest".<br>
...
public class _72536SupportMissionInTheAncientRedwoodForest extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for the mission in the Ancient Redwood Forest.<br>
	 * This method sets up the quest with the ID {@code 72536}.<br>
	...
	/*
	 * @Override public boolean onKillEvent(QuestEnv env) { Player player = env.getPlayer(); QuestState qs = player.getQuestStateList().getQuestState(questId); if (qs != null && qs.getStatus() == QuestStatus.START) { int var = qs.getQuestVarById(0); int var1 = qs.getQuestVarById(1); // (0) Step: 0, Count: 10, Mobs : 655112, 655113, 655114, 655115, 655116, 655117, 655118 if (var == 0 && var1 < 9) { return defaultOnKillEvent(env, mobs, var1, var1 + 1, 1); } else { qs.setQuestVar(1); updateQuestStatus(env); } } return false; }
	 */
}
