...
/**
 * Handles the client request to perform a magic craft action.<br>
 * This packet is processed by the {@link MagicCraftService} to execute crafting logic.
...
public class CM_MAGIC_CRAFT extends AionClientPacket
{
	...
	/**
	 * This method initializes a new {@code CM_MAGIC_CRAFT} packet.<br>
