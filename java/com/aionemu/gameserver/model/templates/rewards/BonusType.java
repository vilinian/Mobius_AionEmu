...
/**
 * Defines the different types of bonuses that can be granted as rewards.<br>
 * This enum is used by {@code RewardTemplate} to specify what kind of benefit a player receives.
 * @author Rolandas
 */
