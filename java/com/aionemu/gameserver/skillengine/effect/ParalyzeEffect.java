...
/**
 * Represents a status effect that paralyzes a {@link Creature}.<br>
 * It prevents the target from performing actions for a specific duration.
 * @author ATracer
 */
...
public class ParalyzeEffect extends EffectTemplate
{
	...
	/**
	 * Starts the {@link Effect} and applies paralysis to the target.<br>
	 * This method cancels the current skill and aborts movement for the creature.<br>
	 * It sets the abnormal state to {@code PARALYZE}.
