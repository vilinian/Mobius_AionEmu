...
/**
 * Represents the attributes associated with Free-to-Play (F2P) bonuses.<br>
 * This class stores configuration data for specific bonus effects within the {@code bonus_service} system.
 */
...
public class F2pBonusAttr
{
	...
	/**
	 * Retrieves the list of penalty attributes associated with this bonus.<br>
	 * If the list is {@code null}, it initializes a new {@code ArrayList}
	 * @return A {@code List} of {@link F2pPenalityAttr} objects.
	 */
