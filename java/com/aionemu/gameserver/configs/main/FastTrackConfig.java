...
/**
 * This class manages the configuration settings for the {@code FastTrack} system.<br>
 * It allows administrators to tune performance and behavior parameters via configuration files.
 * @author -Enomine-
 * @rework Eloann
 */
