...
/**
 * Handles the logic for teleporting a target to a specific location.<br>
 * This effect is triggered as part of a skill execution within the {@link EffectTemplate} system.
 * @author Rolandas
 */
...
public class TargetTeleportEffect extends EffectTemplate
{
	...
	{
		// If isSameMap is false and they are in the same map, handle this manually by teleporting the entity to a distance in front of the NPC.
	}
}
