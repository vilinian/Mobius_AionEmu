...
/**
 * Represents an instant damage effect triggered by a spell attack.<br>
 * This class handles the immediate application of damage to a target.<br>
 * It extends {@link DamageEffect} to provide specific behavior for instantaneous hits.
 * @author ATracer
 */
...
public class SpellAttackInstantEffect extends DamageEffect
{
	...
	public void calculate(Effect effect)
	{
		...
		/*
		 * if (effect.getSkillId() == 2713) { if (effected instanceof Npc) { effect.getEffected().getEffectController().setAbnormal(AbnormalState.STUN.getId()); } else if (effected instanceof Player) { return; } }
		 */
