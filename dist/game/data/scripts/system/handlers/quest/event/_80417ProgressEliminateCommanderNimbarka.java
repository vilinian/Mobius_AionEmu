...
/**
 * Handles the progress for eliminating Commander Nimbarka in quest {@code 80417}.<br>
 * This class manages the logic triggered when the target is defeated.<br>
 * It updates the {@link QuestState} to reflect the completion of this specific objective.
...
public class _80417ProgressEliminateCommanderNimbarka extends QuestHandler
{
	...
	/**
	 * Initializes the quest handler for progress in eliminating Commander Nimbarka.<br>
