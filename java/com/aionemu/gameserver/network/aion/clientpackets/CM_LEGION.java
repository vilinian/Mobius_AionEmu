...
/**
 * Handles the client request to create or manage a {@link Legion}.<br>
 * This packet processes data sent from the client to update legion information.<br>
 * It interacts with {@link LegionService} to validate and execute the requested actions.
...
public class CM_LEGION extends AionClientPacket
{
	...
	/**
	 * Creates a new instance of the {@link CM_LEGION} packet.<br>
